// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/ses_mail_manager_archive
...
export interface DataAwsccSesMailManagerArchiveConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/ses_mail_manager_archive#id DataAwsccSesMailManagerArchive#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/ses_mail_manager_archive awscc_ses_mail_manager_archive}
*/
export class DataAwsccSesMailManagerArchive extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSesMailManagerArchive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/ses_mail_manager_archive#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/ses_mail_manager_archive awscc_ses_mail_manager_archive} Data Source
  *
  * @param scope The scope in which to define this construct
