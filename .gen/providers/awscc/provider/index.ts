// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs
...
export interface AwsccProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#access_key AwsccProvider#access_key}
  */
  readonly accessKey?: string;
  /**
  * An `assume_role` block (documented below). Only one `assume_role` block may be in the configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#assume_role AwsccProvider#assume_role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#assume_role_with_web_identity AwsccProvider#assume_role_with_web_identity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#endpoints AwsccProvider#endpoints}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#http_proxy AwsccProvider#http_proxy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#https_proxy AwsccProvider#https_proxy}
  */
  readonly httpsProxy?: string;
  /**
  * Explicitly allow the provider to perform "insecure" SSL requests. If not set, defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#insecure AwsccProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#max_retries AwsccProvider#max_retries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#no_proxy AwsccProvider#no_proxy}
  */
  readonly noProxy?: string;
  /**
  * This is the AWS profile name as set in the shared credentials file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#profile AwsccProvider#profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#region AwsccProvider#region}
  */
  readonly region?: string;
  /**
  * Amazon Resource Name of the AWS CloudFormation service role that is used on your behalf to perform operations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#role_arn AwsccProvider#role_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#secret_key AwsccProvider#secret_key}
  */
  readonly secretKey?: string;
  /**
  * List of paths to shared config files. If not set, defaults to `~/.aws/config`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#shared_config_files AwsccProvider#shared_config_files}
  */
  readonly sharedConfigFiles?: string[];
  /**
  * List of paths to shared credentials files. If not set, defaults to `~/.aws/credentials`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#shared_credentials_files AwsccProvider#shared_credentials_files}
  */
  readonly sharedCredentialsFiles?: string[];
  /**
  * Skip the AWS Metadata API check. Useful for AWS API implementations that do not have a metadata API endpoint.  Setting to `true` prevents Terraform from authenticating via the Metadata API. You may need to use other authentication methods like static credentials, configuration variables, or environment variables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#skip_medatadata_api_check AwsccProvider#skip_medatadata_api_check}
  */
  readonly skipMedatadataApiCheck?: boolean | cdktn.IResolvable;
  /**
  * Skip the AWS Metadata API check. Useful for AWS API implementations that do not have a metadata API endpoint.  Setting to `true` prevents Terraform from authenticating via the Metadata API. You may need to use other authentication methods like static credentials, configuration variables, or environment variables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#skip_metadata_api_check AwsccProvider#skip_metadata_api_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#token AwsccProvider#token}
  */
  readonly token?: string;
  /**
  * Product details to append to the User-Agent string sent in all AWS API calls.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#user_agent AwsccProvider#user_agent}
  */
  readonly userAgent?: AwsccProviderUserAgent[] | cdktn.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#alias AwsccProvider#alias}
  */
...
export interface AwsccProviderAssumeRole {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#duration AwsccProvider#duration}
  */
  readonly duration?: string;
  /**
  * External identifier to use when assuming the role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#external_id AwsccProvider#external_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#policy AwsccProvider#policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#policy_arns AwsccProvider#policy_arns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#session_name AwsccProvider#session_name}
  */
  readonly sessionName?: string;
  /**
  * Map of assume role session tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#tags AwsccProvider#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Set of assume role session tag keys to pass to any subsequent sessions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#transitive_tag_keys AwsccProvider#transitive_tag_keys}
  */
...
export interface AwsccProviderAssumeRoleWithWebIdentity {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#web_identity_token AwsccProvider#web_identity_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#web_identity_token_file AwsccProvider#web_identity_token_file}
  */
...
export interface AwsccProviderEndpoints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#cloudcontrolapi AwsccProvider#cloudcontrolapi}
  */
  readonly cloudcontrolapi?: string;
  /**
  * Use this to override the default IAM service endpoint URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#iam AwsccProvider#iam}
  */
  readonly iam?: string;
  /**
  * Use this to override the default SSO service endpoint URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#sso AwsccProvider#sso}
  */
  readonly sso?: string;
  /**
  * Use this to override the default STS service endpoint URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#sts AwsccProvider#sts}
  */
  readonly sts?: string;
}
...
export interface AwsccProviderUserAgent {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#comment AwsccProvider#comment}
  */
  readonly comment?: string;
  /**
  * Product name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#product_name AwsccProvider#product_name}
  */
  readonly productName: string;
  /**
  * Product version. Optional, and should only be set when `product_name` is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#product_version AwsccProvider#product_version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs awscc}
*/
export class AwsccProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AwsccProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs awscc} Resource
  *
  * @param scope The scope in which to define this construct
