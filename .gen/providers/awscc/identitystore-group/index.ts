// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group
...
export interface IdentitystoreGroupConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group#description IdentitystoreGroup#description}
  */
  readonly description?: string;
  /**
  * A string containing the name of the group. This value is commonly displayed when the group is referenced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group#display_name IdentitystoreGroup#display_name}
  */
  readonly displayName: string;
  /**
  * The globally unique identifier for the identity store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group#identity_store_id IdentitystoreGroup#identity_store_id}
  */
  readonly identityStoreId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group awscc_identitystore_group}
*/
export class IdentitystoreGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentitystoreGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/identitystore_group awscc_identitystore_group} Resource
  *
  * @param scope The scope in which to define this construct
