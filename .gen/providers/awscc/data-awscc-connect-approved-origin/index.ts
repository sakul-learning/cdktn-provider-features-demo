// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/connect_approved_origin
...
export interface DataAwsccConnectApprovedOriginConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/connect_approved_origin#id DataAwsccConnectApprovedOrigin#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/connect_approved_origin awscc_connect_approved_origin}
*/
export class DataAwsccConnectApprovedOrigin extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConnectApprovedOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/connect_approved_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/connect_approved_origin awscc_connect_approved_origin} Data Source
  *
  * @param scope The scope in which to define this construct
