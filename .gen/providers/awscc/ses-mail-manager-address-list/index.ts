// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list
...
export interface SesMailManagerAddressListConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list#address_list_name SesMailManagerAddressList#address_list_name}
  */
  readonly addressListName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list#tags SesMailManagerAddressList#tags}
  */
  readonly tags?: SesMailManagerAddressListTags[] | cdktn.IResolvable;
}
export interface SesMailManagerAddressListTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list#key SesMailManagerAddressList#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list#value SesMailManagerAddressList#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list awscc_ses_mail_manager_address_list}
*/
export class SesMailManagerAddressList extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesMailManagerAddressList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ses_mail_manager_address_list awscc_ses_mail_manager_address_list} Resource
  *
  * @param scope The scope in which to define this construct
