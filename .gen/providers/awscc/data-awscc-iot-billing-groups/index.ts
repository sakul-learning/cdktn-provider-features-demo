// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_billing_groups
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_billing_groups awscc_iot_billing_groups}
*/
export class DataAwsccIotBillingGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotBillingGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_billing_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_billing_groups awscc_iot_billing_groups} Data Source
  *
  * @param scope The scope in which to define this construct
