// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_instance_profile
...
export interface DataAwsccIamInstanceProfileConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_instance_profile#id DataAwsccIamInstanceProfile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_instance_profile awscc_iam_instance_profile}
*/
export class DataAwsccIamInstanceProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIamInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_instance_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_instance_profile awscc_iam_instance_profile} Data Source
  *
  * @param scope The scope in which to define this construct
