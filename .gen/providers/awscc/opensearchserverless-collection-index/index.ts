// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index
...
export interface OpensearchserverlessCollectionIndexConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index#collection_index_id OpensearchserverlessCollectionIndex#collection_index_id}
  */
  readonly collectionIndexId: string;
  /**
  * The name of the collection index
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index#index_name OpensearchserverlessCollectionIndex#index_name}
  */
  readonly indexName: string;
  /**
  * The Mappings for the collection index
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index#index_schema OpensearchserverlessCollectionIndex#index_schema}
  */
  readonly indexSchema?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index awscc_opensearchserverless_collection_index}
*/
export class OpensearchserverlessCollectionIndex extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchserverlessCollectionIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/opensearchserverless_collection_index awscc_opensearchserverless_collection_index} Resource
  *
  * @param scope The scope in which to define this construct
