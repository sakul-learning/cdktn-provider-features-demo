// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer
...
export interface KinesisStreamConsumerConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer#consumer_name KinesisStreamConsumer#consumer_name}
  */
  readonly consumerName: string;
  /**
  * The Amazon resource name (ARN) of the Kinesis data stream that you want to register the consumer with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer#stream_arn KinesisStreamConsumer#stream_arn}
  */
  readonly streamArn: string;
  /**
  * An arbitrary set of tags (key–value pairs) to associate with the Kinesis consumer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer#tags KinesisStreamConsumer#tags}
  */
...
export interface KinesisStreamConsumerTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer#key KinesisStreamConsumer#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 255 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer#value KinesisStreamConsumer#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer awscc_kinesis_stream_consumer}
*/
export class KinesisStreamConsumer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisStreamConsumer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/kinesis_stream_consumer awscc_kinesis_stream_consumer} Resource
  *
  * @param scope The scope in which to define this construct
