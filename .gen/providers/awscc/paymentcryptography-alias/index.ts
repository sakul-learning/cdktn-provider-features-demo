// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/paymentcryptography_alias
...
export interface PaymentcryptographyAliasConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/paymentcryptography_alias#alias_name PaymentcryptographyAlias#alias_name}
  */
  readonly aliasName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/paymentcryptography_alias#key_arn PaymentcryptographyAlias#key_arn}
  */
  readonly keyArn?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/paymentcryptography_alias awscc_paymentcryptography_alias}
*/
export class PaymentcryptographyAlias extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PaymentcryptographyAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/paymentcryptography_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/paymentcryptography_alias awscc_paymentcryptography_alias} Resource
  *
  * @param scope The scope in which to define this construct
