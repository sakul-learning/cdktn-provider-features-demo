// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_batch_scram_secret
...
export interface MskBatchScramSecretConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_batch_scram_secret#cluster_arn MskBatchScramSecret#cluster_arn}
  */
  readonly clusterArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_batch_scram_secret#secret_arn_list MskBatchScramSecret#secret_arn_list}
  */
  readonly secretArnList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_batch_scram_secret awscc_msk_batch_scram_secret}
*/
export class MskBatchScramSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskBatchScramSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_batch_scram_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_batch_scram_secret awscc_msk_batch_scram_secret} Resource
  *
  * @param scope The scope in which to define this construct
