// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/bedrock_resource_policy
...
export interface BedrockResourcePolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/bedrock_resource_policy#policy_document BedrockResourcePolicy#policy_document}
  */
  readonly policyDocument: string;
  /**
  * The ARN of the Bedrock Guardrail or Guardrail Profile resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/bedrock_resource_policy#resource_arn BedrockResourcePolicy#resource_arn}
  */
  readonly resourceArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/bedrock_resource_policy awscc_bedrock_resource_policy}
*/
export class BedrockResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/bedrock_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/bedrock_resource_policy awscc_bedrock_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
