// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_managed_policy
...
export interface DataAwsccIamManagedPolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_managed_policy#id DataAwsccIamManagedPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_managed_policy awscc_iam_managed_policy}
*/
export class DataAwsccIamManagedPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIamManagedPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_managed_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iam_managed_policy awscc_iam_managed_policy} Data Source
  *
  * @param scope The scope in which to define this construct
