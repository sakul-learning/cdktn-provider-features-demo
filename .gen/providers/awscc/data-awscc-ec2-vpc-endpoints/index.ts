// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_vpc_endpoints
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_vpc_endpoints awscc_ec2_vpc_endpoints}
*/
export class DataAwsccEc2VpcEndpoints extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2VpcEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_vpc_endpoints#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_vpc_endpoints awscc_ec2_vpc_endpoints} Data Source
  *
  * @param scope The scope in which to define this construct
