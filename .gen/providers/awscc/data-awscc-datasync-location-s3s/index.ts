// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/datasync_location_s3s
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/datasync_location_s3s awscc_datasync_location_s3s}
*/
export class DataAwsccDatasyncLocationS3S extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDatasyncLocationS3S that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/datasync_location_s3s#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/datasync_location_s3s awscc_datasync_location_s3s} Data Source
  *
  * @param scope The scope in which to define this construct
