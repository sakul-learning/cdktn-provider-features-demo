// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/emr_studio_session_mapping
...
export interface DataAwsccEmrStudioSessionMappingConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/emr_studio_session_mapping#id DataAwsccEmrStudioSessionMapping#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/emr_studio_session_mapping awscc_emr_studio_session_mapping}
*/
export class DataAwsccEmrStudioSessionMapping extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEmrStudioSessionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/emr_studio_session_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/emr_studio_session_mapping awscc_emr_studio_session_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
