// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/chime_app_instance_bot
...
export interface DataAwsccChimeAppInstanceBotConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/chime_app_instance_bot#id DataAwsccChimeAppInstanceBot#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/chime_app_instance_bot awscc_chime_app_instance_bot}
*/
export class DataAwsccChimeAppInstanceBot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccChimeAppInstanceBot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/chime_app_instance_bot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/chime_app_instance_bot awscc_chime_app_instance_bot} Data Source
  *
  * @param scope The scope in which to define this construct
