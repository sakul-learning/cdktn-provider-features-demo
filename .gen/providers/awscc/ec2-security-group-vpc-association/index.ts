// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_security_group_vpc_association
...
export interface Ec2SecurityGroupVpcAssociationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_security_group_vpc_association#group_id Ec2SecurityGroupVpcAssociation#group_id}
  */
  readonly groupId: string;
  /**
  * The ID of the VPC in the security group vpc association.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_security_group_vpc_association#vpc_id Ec2SecurityGroupVpcAssociation#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_security_group_vpc_association awscc_ec2_security_group_vpc_association}
*/
export class Ec2SecurityGroupVpcAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SecurityGroupVpcAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_security_group_vpc_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_security_group_vpc_association awscc_ec2_security_group_vpc_association} Resource
  *
  * @param scope The scope in which to define this construct
