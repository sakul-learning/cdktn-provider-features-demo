// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection
...
export interface Route53CidrCollectionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection#locations Route53CidrCollection#locations}
  */
  readonly locations?: Route53CidrCollectionLocations[] | cdktn.IResolvable;
  /**
  * A unique name for the CIDR collection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection#name Route53CidrCollection#name}
  */
...
export interface Route53CidrCollectionLocations {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection#cidr_list Route53CidrCollection#cidr_list}
  */
  readonly cidrList?: string[];
  /**
  * The name of the location that is associated with the CIDR collection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection#location_name Route53CidrCollection#location_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection awscc_route53_cidr_collection}
*/
export class Route53CidrCollection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53CidrCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/route53_cidr_collection awscc_route53_cidr_collection} Resource
  *
  * @param scope The scope in which to define this construct
