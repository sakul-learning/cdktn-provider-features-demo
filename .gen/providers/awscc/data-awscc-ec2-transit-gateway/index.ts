// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_transit_gateway
...
export interface DataAwsccEc2TransitGatewayConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_transit_gateway#id DataAwsccEc2TransitGateway#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_transit_gateway awscc_ec2_transit_gateway}
*/
export class DataAwsccEc2TransitGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2TransitGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_transit_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_transit_gateway awscc_ec2_transit_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
