// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment
...
export interface BatchServiceEnvironmentConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#capacity_limits BatchServiceEnvironment#capacity_limits}
  */
  readonly capacityLimits: BatchServiceEnvironmentCapacityLimits[] | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#service_environment_name BatchServiceEnvironment#service_environment_name}
  */
  readonly serviceEnvironmentName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#service_environment_type BatchServiceEnvironment#service_environment_type}
  */
  readonly serviceEnvironmentType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#state BatchServiceEnvironment#state}
  */
  readonly state?: string;
  /**
  * A key-value pair to associate with a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#tags BatchServiceEnvironment#tags}
  */
  readonly tags?: { [key: string]: string };
}
export interface BatchServiceEnvironmentCapacityLimits {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#capacity_unit BatchServiceEnvironment#capacity_unit}
  */
  readonly capacityUnit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#max_capacity BatchServiceEnvironment#max_capacity}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment awscc_batch_service_environment}
*/
export class BatchServiceEnvironment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BatchServiceEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/batch_service_environment awscc_batch_service_environment} Resource
  *
  * @param scope The scope in which to define this construct
