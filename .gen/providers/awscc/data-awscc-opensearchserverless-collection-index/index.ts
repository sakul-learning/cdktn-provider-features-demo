// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/opensearchserverless_collection_index
...
export interface DataAwsccOpensearchserverlessCollectionIndexConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/opensearchserverless_collection_index#id DataAwsccOpensearchserverlessCollectionIndex#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/opensearchserverless_collection_index awscc_opensearchserverless_collection_index}
*/
export class DataAwsccOpensearchserverlessCollectionIndex extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOpensearchserverlessCollectionIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/opensearchserverless_collection_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/opensearchserverless_collection_index awscc_opensearchserverless_collection_index} Data Source
  *
  * @param scope The scope in which to define this construct
