// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/nimblestudio_studio
...
export interface DataAwsccNimblestudioStudioConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/nimblestudio_studio#id DataAwsccNimblestudioStudio#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/nimblestudio_studio awscc_nimblestudio_studio}
*/
export class DataAwsccNimblestudioStudio extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccNimblestudioStudio that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/nimblestudio_studio#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/nimblestudio_studio awscc_nimblestudio_studio} Data Source
  *
  * @param scope The scope in which to define this construct
