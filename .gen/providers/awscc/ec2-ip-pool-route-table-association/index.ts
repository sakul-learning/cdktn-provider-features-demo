// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ip_pool_route_table_association
...
export interface Ec2IpPoolRouteTableAssociationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ip_pool_route_table_association#public_ipv_4_pool Ec2IpPoolRouteTableAssociation#public_ipv_4_pool}
  */
  readonly publicIpv4Pool: string;
  /**
  * The ID of the route table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ip_pool_route_table_association#route_table_id Ec2IpPoolRouteTableAssociation#route_table_id}
  */
  readonly routeTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ip_pool_route_table_association awscc_ec2_ip_pool_route_table_association}
*/
export class Ec2IpPoolRouteTableAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2IpPoolRouteTableAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ip_pool_route_table_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ip_pool_route_table_association awscc_ec2_ip_pool_route_table_association} Resource
  *
  * @param scope The scope in which to define this construct
