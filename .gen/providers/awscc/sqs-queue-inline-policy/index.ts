// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/sqs_queue_inline_policy
...
export interface SqsQueueInlinePolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/sqs_queue_inline_policy#policy_document SqsQueueInlinePolicy#policy_document}
  */
  readonly policyDocument: string;
  /**
  * The URL of the SQS queue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/sqs_queue_inline_policy#queue SqsQueueInlinePolicy#queue}
  */
  readonly queue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/sqs_queue_inline_policy awscc_sqs_queue_inline_policy}
*/
export class SqsQueueInlinePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SqsQueueInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/sqs_queue_inline_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/sqs_queue_inline_policy awscc_sqs_queue_inline_policy} Resource
  *
  * @param scope The scope in which to define this construct
