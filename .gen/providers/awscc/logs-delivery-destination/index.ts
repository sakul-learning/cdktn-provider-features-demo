// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination
...
export interface LogsDeliveryDestinationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#delivery_destination_policy LogsDeliveryDestination#delivery_destination_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#delivery_destination_type LogsDeliveryDestination#delivery_destination_type}
  */
  readonly deliveryDestinationType?: string;
  /**
  * The ARN of the Amazon Web Services destination that this delivery destination represents. That Amazon Web Services destination can be a log group in CloudWatch Logs, an Amazon S3 bucket, or a delivery stream in Firehose.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#destination_resource_arn LogsDeliveryDestination#destination_resource_arn}
  */
  readonly destinationResourceArn?: string;
  /**
  * The name of this delivery destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#name LogsDeliveryDestination#name}
  */
  readonly name: string;
  /**
  * The format of the logs that are sent to this delivery destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#output_format LogsDeliveryDestination#output_format}
  */
  readonly outputFormat?: string;
  /**
  * The tags that have been assigned to this delivery destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#tags LogsDeliveryDestination#tags}
  */
...
export interface LogsDeliveryDestinationDeliveryDestinationPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#delivery_destination_name LogsDeliveryDestination#delivery_destination_name}
  */
...
export interface LogsDeliveryDestinationTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#key LogsDeliveryDestination#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#value LogsDeliveryDestination#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination awscc_logs_delivery_destination}
*/
export class LogsDeliveryDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsDeliveryDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_delivery_destination awscc_logs_delivery_destination} Resource
  *
  * @param scope The scope in which to define this construct
