// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata
...
export interface GlueSchemaVersionMetadataConfig extends cdktn.TerraformMetaArguments {
  ...
  * Metadata key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata#key GlueSchemaVersionMetadata#key}
  */
  readonly key: string;
  /**
  * Represents the version ID associated with the schema version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata#schema_version_id GlueSchemaVersionMetadata#schema_version_id}
  */
  readonly schemaVersionId: string;
  /**
  * Metadata value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata#value GlueSchemaVersionMetadata#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata awscc_glue_schema_version_metadata}
*/
export class GlueSchemaVersionMetadata extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueSchemaVersionMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_schema_version_metadata awscc_glue_schema_version_metadata} Resource
  *
  * @param scope The scope in which to define this construct
