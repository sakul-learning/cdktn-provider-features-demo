// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_message_template_version
...
export interface WisdomMessageTemplateVersionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_message_template_version#message_template_arn WisdomMessageTemplateVersion#message_template_arn}
  */
  readonly messageTemplateArn: string;
  /**
  * The content SHA256 of the message template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_message_template_version#message_template_content_sha_256 WisdomMessageTemplateVersion#message_template_content_sha_256}
  */
  readonly messageTemplateContentSha256?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_message_template_version awscc_wisdom_message_template_version}
*/
export class WisdomMessageTemplateVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WisdomMessageTemplateVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_message_template_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_message_template_version awscc_wisdom_message_template_version} Resource
  *
  * @param scope The scope in which to define this construct
