// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_cluster_policy
...
export interface MskClusterPolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_cluster_policy#cluster_arn MskClusterPolicy#cluster_arn}
  */
  readonly clusterArn: string;
  /**
  * A policy document containing permissions to add to the specified cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_cluster_policy#policy MskClusterPolicy#policy}
  */
  readonly policy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_cluster_policy awscc_msk_cluster_policy}
*/
export class MskClusterPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskClusterPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_cluster_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/msk_cluster_policy awscc_msk_cluster_policy} Resource
  *
  * @param scope The scope in which to define this construct
