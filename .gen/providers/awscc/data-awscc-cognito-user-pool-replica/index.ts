// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cognito_user_pool_replica
...
export interface DataAwsccCognitoUserPoolReplicaConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cognito_user_pool_replica#id DataAwsccCognitoUserPoolReplica#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cognito_user_pool_replica awscc_cognito_user_pool_replica}
*/
export class DataAwsccCognitoUserPoolReplica extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoUserPoolReplica that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cognito_user_pool_replica#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cognito_user_pool_replica awscc_cognito_user_pool_replica} Data Source
  *
  * @param scope The scope in which to define this construct
