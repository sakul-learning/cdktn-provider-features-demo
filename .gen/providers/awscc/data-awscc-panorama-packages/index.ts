// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/panorama_packages
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/panorama_packages awscc_panorama_packages}
*/
export class DataAwsccPanoramaPackages extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPanoramaPackages that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/panorama_packages#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/panorama_packages awscc_panorama_packages} Data Source
  *
  * @param scope The scope in which to define this construct
