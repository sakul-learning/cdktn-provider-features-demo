// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_load_balancer_tls_certificates
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_load_balancer_tls_certificates awscc_lightsail_load_balancer_tls_certificates}
*/
export class DataAwsccLightsailLoadBalancerTlsCertificates extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLightsailLoadBalancerTlsCertificates that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_load_balancer_tls_certificates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_load_balancer_tls_certificates awscc_lightsail_load_balancer_tls_certificates} Data Source
  *
  * @param scope The scope in which to define this construct
