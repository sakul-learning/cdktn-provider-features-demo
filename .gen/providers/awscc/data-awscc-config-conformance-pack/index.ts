// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/config_conformance_pack
...
export interface DataAwsccConfigConformancePackConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/config_conformance_pack#id DataAwsccConfigConformancePack#id}
  *
...
export interface DataAwsccConfigConformancePackTags {
}

export function dataAwsccConfigConformancePackTagsToTerraform(struct?: DataAwsccConfigConformancePackTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccConfigConformancePackTagsToHclTerraform(struct?: DataAwsccConfigConformancePackTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccConfigConformancePackTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccConfigConformancePackTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccConfigConformancePackTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccConfigConformancePackTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccConfigConformancePackTagsOutputReference {
    return new DataAwsccConfigConformancePackTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/config_conformance_pack awscc_config_conformance_pack}
*/
export class DataAwsccConfigConformancePack extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccConfigConformancePack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/config_conformance_pack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/config_conformance_pack awscc_config_conformance_pack} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new DataAwsccConfigConformancePackTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
