// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/glue_integration_resource_properties
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/glue_integration_resource_properties awscc_glue_integration_resource_properties}
*/
export class DataAwsccGlueIntegrationResourceProperties extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGlueIntegrationResourceProperties that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/glue_integration_resource_properties#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/glue_integration_resource_properties awscc_glue_integration_resource_properties} Data Source
  *
  * @param scope The scope in which to define this construct
