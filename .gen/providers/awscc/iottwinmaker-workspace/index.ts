// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace
...
export interface IottwinmakerWorkspaceConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace#description IottwinmakerWorkspace#description}
  */
  readonly description?: string;
  /**
  * The ARN of the execution role associated with the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace#role IottwinmakerWorkspace#role}
  */
  readonly role: string;
  /**
  * The ARN of the S3 bucket where resources associated with the workspace are stored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace#s3_location IottwinmakerWorkspace#s3_location}
  */
  readonly s3Location: string;
  /**
  * A map of key-value pairs to associate with a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace#tags IottwinmakerWorkspace#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The ID of the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace#workspace_id IottwinmakerWorkspace#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace awscc_iottwinmaker_workspace}
*/
export class IottwinmakerWorkspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IottwinmakerWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_workspace awscc_iottwinmaker_workspace} Resource
  *
  * @param scope The scope in which to define this construct
