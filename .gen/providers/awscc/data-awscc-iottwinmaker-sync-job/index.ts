// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/iottwinmaker_sync_job
...
export interface DataAwsccIottwinmakerSyncJobConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/iottwinmaker_sync_job#id DataAwsccIottwinmakerSyncJob#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/iottwinmaker_sync_job awscc_iottwinmaker_sync_job}
*/
export class DataAwsccIottwinmakerSyncJob extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIottwinmakerSyncJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/iottwinmaker_sync_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/iottwinmaker_sync_job awscc_iottwinmaker_sync_job} Data Source
  *
  * @param scope The scope in which to define this construct
