// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticache_global_replication_groups
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticache_global_replication_groups awscc_elasticache_global_replication_groups}
*/
export class DataAwsccElasticacheGlobalReplicationGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElasticacheGlobalReplicationGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticache_global_replication_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticache_global_replication_groups awscc_elasticache_global_replication_groups} Data Source
  *
  * @param scope The scope in which to define this construct
