// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticloadbalancingv2_listener
...
export interface DataAwsccElasticloadbalancingv2ListenerConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticloadbalancingv2_listener#id DataAwsccElasticloadbalancingv2Listener#id}
  *
...
export interface DataAwsccElasticloadbalancingv2ListenerTags {
}

export function dataAwsccElasticloadbalancingv2ListenerTagsToTerraform(struct?: DataAwsccElasticloadbalancingv2ListenerTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsccElasticloadbalancingv2ListenerTagsToHclTerraform(struct?: DataAwsccElasticloadbalancingv2ListenerTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccElasticloadbalancingv2ListenerTagsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsccElasticloadbalancingv2ListenerTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccElasticloadbalancingv2ListenerTags | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsccElasticloadbalancingv2ListenerTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccElasticloadbalancingv2ListenerTagsOutputReference {
    return new DataAwsccElasticloadbalancingv2ListenerTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticloadbalancingv2_listener awscc_elasticloadbalancingv2_listener}
*/
export class DataAwsccElasticloadbalancingv2Listener extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccElasticloadbalancingv2Listener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticloadbalancingv2_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/elasticloadbalancingv2_listener awscc_elasticloadbalancingv2_listener} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tags = new DataAwsccElasticloadbalancingv2ListenerTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
