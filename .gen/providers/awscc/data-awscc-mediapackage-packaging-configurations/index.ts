// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/mediapackage_packaging_configurations
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/mediapackage_packaging_configurations awscc_mediapackage_packaging_configurations}
*/
export class DataAwsccMediapackagePackagingConfigurations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMediapackagePackagingConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/mediapackage_packaging_configurations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/mediapackage_packaging_configurations awscc_mediapackage_packaging_configurations} Data Source
  *
  * @param scope The scope in which to define this construct
