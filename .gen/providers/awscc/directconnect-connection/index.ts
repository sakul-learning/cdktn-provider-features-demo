// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection
...
export interface DirectconnectConnectionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#bandwidth DirectconnectConnection#bandwidth}
  */
  readonly bandwidth: string;
  /**
  * The name of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#connection_name DirectconnectConnection#connection_name}
  */
  readonly connectionName: string;
  /**
  * The ID or ARN of the LAG to associate the connection with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#lag_id DirectconnectConnection#lag_id}
  */
  readonly lagId?: string;
  /**
  * The location of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#location DirectconnectConnection#location}
  */
  readonly location: string;
  /**
  * The name of the service provider associated with the requested connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#provider_name DirectconnectConnection#provider_name}
  */
  readonly providerName?: string;
  /**
  * Indicates whether you want the connection to support MAC Security (MACsec).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#request_mac_sec DirectconnectConnection#request_mac_sec}
  */
  readonly requestMacSec?: boolean | cdktn.IResolvable;
  /**
  * The tags associated with the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#tags DirectconnectConnection#tags}
  */
...
export interface DirectconnectConnectionTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#key DirectconnectConnection#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#value DirectconnectConnection#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection awscc_directconnect_connection}
*/
export class DirectconnectConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectconnectConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/directconnect_connection awscc_directconnect_connection} Resource
  *
  * @param scope The scope in which to define this construct
