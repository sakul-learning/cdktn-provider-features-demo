// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/logs_metric_filter
...
export interface DataAwsccLogsMetricFilterConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/logs_metric_filter#id DataAwsccLogsMetricFilter#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/logs_metric_filter awscc_logs_metric_filter}
*/
export class DataAwsccLogsMetricFilter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsMetricFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/logs_metric_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/logs_metric_filter awscc_logs_metric_filter} Data Source
  *
  * @param scope The scope in which to define this construct
