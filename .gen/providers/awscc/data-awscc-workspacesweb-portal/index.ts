// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/workspacesweb_portal
...
export interface DataAwsccWorkspaceswebPortalConfig extends cdktn.TerraformMetaArguments {
  /**
  * Uniquely identifies the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/workspacesweb_portal#id DataAwsccWorkspaceswebPortal#id}
  *
...
export interface DataAwsccWorkspaceswebPortalTags {
}

export function dataAwsccWorkspaceswebPortalTagsToTerraform(struct?: DataAwsccWorkspaceswebPortalTags): any {
...
export function dataAwsccWorkspaceswebPortalTagsToHclTerraform(struct?: DataAwsccWorkspaceswebPortalTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccWorkspaceswebPortalTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccWorkspaceswebPortalTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccWorkspaceswebPortalTags | undefined) {
    if (value === undefined) {
...
export class DataAwsccWorkspaceswebPortalTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccWorkspaceswebPortalTagsOutputReference {
    return new DataAwsccWorkspaceswebPortalTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/workspacesweb_portal awscc_workspacesweb_portal}
*/
export class DataAwsccWorkspaceswebPortal extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccWorkspaceswebPortal to import
  * @param importFromId The id of the existing DataAwsccWorkspaceswebPortal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/workspacesweb_portal#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccWorkspaceswebPortal to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/workspacesweb_portal awscc_workspacesweb_portal} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAwsccWorkspaceswebPortalConfig
  */
  public constructor(scope: Construct, id: string, config: DataAwsccWorkspaceswebPortalConfig) {
    super(scope, id, {
  ...
  // portal_custom_domain - computed: true, optional: false, required: false
  ...
  private _tags = new DataAwsccWorkspaceswebPortalTagsList(this, "tags", false);
  public get tags() {
    return this._tags;
  }
