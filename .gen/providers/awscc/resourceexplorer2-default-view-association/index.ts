// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/resourceexplorer2_default_view_association
...
export interface Resourceexplorer2DefaultViewAssociationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/resourceexplorer2_default_view_association#view_arn Resourceexplorer2DefaultViewAssociation#view_arn}
  */
  readonly viewArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/resourceexplorer2_default_view_association awscc_resourceexplorer2_default_view_association}
*/
export class Resourceexplorer2DefaultViewAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resourceexplorer2DefaultViewAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/resourceexplorer2_default_view_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/resourceexplorer2_default_view_association awscc_resourceexplorer2_default_view_association} Resource
  *
  * @param scope The scope in which to define this construct
