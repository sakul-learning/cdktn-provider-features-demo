// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/batch_consumable_resource
...
export interface DataAwsccBatchConsumableResourceConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/batch_consumable_resource#id DataAwsccBatchConsumableResource#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/batch_consumable_resource awscc_batch_consumable_resource}
*/
export class DataAwsccBatchConsumableResource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBatchConsumableResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/batch_consumable_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/batch_consumable_resource awscc_batch_consumable_resource} Data Source
  *
  * @param scope The scope in which to define this construct
