// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_topic_rules
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_topic_rules awscc_iot_topic_rules}
*/
export class DataAwsccIotTopicRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotTopicRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_topic_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_topic_rules awscc_iot_topic_rules} Data Source
  *
  * @param scope The scope in which to define this construct
