// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/logs_delivery_destination
...
export interface DataAwsccLogsDeliveryDestinationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/logs_delivery_destination#id DataAwsccLogsDeliveryDestination#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/logs_delivery_destination awscc_logs_delivery_destination}
*/
export class DataAwsccLogsDeliveryDestination extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsDeliveryDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/logs_delivery_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/logs_delivery_destination awscc_logs_delivery_destination} Data Source
  *
  * @param scope The scope in which to define this construct
