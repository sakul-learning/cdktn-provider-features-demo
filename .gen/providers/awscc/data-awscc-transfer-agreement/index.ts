// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/transfer_agreement
...
export interface DataAwsccTransferAgreementConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/transfer_agreement#id DataAwsccTransferAgreement#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/transfer_agreement awscc_transfer_agreement}
*/
export class DataAwsccTransferAgreement extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccTransferAgreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/transfer_agreement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/transfer_agreement awscc_transfer_agreement} Data Source
  *
  * @param scope The scope in which to define this construct
