// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_sequence_store
...
export interface DataAwsccOmicsSequenceStoreConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_sequence_store#id DataAwsccOmicsSequenceStore#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_sequence_store awscc_omics_sequence_store}
*/
export class DataAwsccOmicsSequenceStore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOmicsSequenceStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_sequence_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_sequence_store awscc_omics_sequence_store} Data Source
  *
  * @param scope The scope in which to define this construct
