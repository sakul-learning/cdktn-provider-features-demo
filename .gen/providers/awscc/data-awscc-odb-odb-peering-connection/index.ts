// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/odb_odb_peering_connection
...
export interface DataAwsccOdbOdbPeeringConnectionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/odb_odb_peering_connection#id DataAwsccOdbOdbPeeringConnection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/odb_odb_peering_connection awscc_odb_odb_peering_connection}
*/
export class DataAwsccOdbOdbPeeringConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOdbOdbPeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/odb_odb_peering_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/odb_odb_peering_connection awscc_odb_odb_peering_connection} Data Source
  *
  * @param scope The scope in which to define this construct
