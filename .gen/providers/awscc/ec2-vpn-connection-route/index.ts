// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_vpn_connection_route
...
export interface Ec2VpnConnectionRouteConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_vpn_connection_route#destination_cidr_block Ec2VpnConnectionRoute#destination_cidr_block}
  */
  readonly destinationCidrBlock: string;
  /**
  * The ID of the VPN connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_vpn_connection_route#vpn_connection_id Ec2VpnConnectionRoute#vpn_connection_id}
  */
  readonly vpnConnectionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_vpn_connection_route awscc_ec2_vpn_connection_route}
*/
export class Ec2VpnConnectionRoute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpnConnectionRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_vpn_connection_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_vpn_connection_route awscc_ec2_vpn_connection_route} Resource
  *
  * @param scope The scope in which to define this construct
