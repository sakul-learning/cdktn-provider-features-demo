// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene
...
export interface IottwinmakerSceneConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#capabilities IottwinmakerScene#capabilities}
  */
  readonly capabilities?: string[];
  /**
  * The relative path that specifies the location of the content definition file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#content_location IottwinmakerScene#content_location}
  */
  readonly contentLocation: string;
  /**
  * The description of the scene.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#description IottwinmakerScene#description}
  */
  readonly description?: string;
  /**
  * The ID of the scene.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#scene_id IottwinmakerScene#scene_id}
  */
  readonly sceneId: string;
  /**
  * A key-value pair of scene metadata for the scene.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#scene_metadata IottwinmakerScene#scene_metadata}
  */
  readonly sceneMetadata?: { [key: string]: string };
  /**
  * A key-value pair to associate with a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#tags IottwinmakerScene#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The ID of the scene.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#workspace_id IottwinmakerScene#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene awscc_iottwinmaker_scene}
*/
export class IottwinmakerScene extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IottwinmakerScene that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_scene awscc_iottwinmaker_scene} Resource
  *
  * @param scope The scope in which to define this construct
