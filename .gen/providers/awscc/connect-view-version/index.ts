// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version
...
export interface ConnectViewVersionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version#version_description ConnectViewVersion#version_description}
  */
  readonly versionDescription?: string;
  /**
  * The Amazon Resource Name (ARN) of the view for which a version is being created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version#view_arn ConnectViewVersion#view_arn}
  */
  readonly viewArn: string;
  /**
  * The view content hash to be checked.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version#view_content_sha_256 ConnectViewVersion#view_content_sha_256}
  */
  readonly viewContentSha256?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version awscc_connect_view_version}
*/
export class ConnectViewVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectViewVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/connect_view_version awscc_connect_view_version} Resource
  *
  * @param scope The scope in which to define this construct
