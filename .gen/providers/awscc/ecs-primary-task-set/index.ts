// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set
...
export interface EcsPrimaryTaskSetConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set#cluster EcsPrimaryTaskSet#cluster}
  */
  readonly cluster: string;
  /**
  * The short name or full Amazon Resource Name (ARN) of the service to create the task set in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set#service EcsPrimaryTaskSet#service}
  */
  readonly service: string;
  /**
  * The ID or full Amazon Resource Name (ARN) of the task set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set#task_set_id EcsPrimaryTaskSet#task_set_id}
  */
  readonly taskSetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set awscc_ecs_primary_task_set}
*/
export class EcsPrimaryTaskSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsPrimaryTaskSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecs_primary_task_set awscc_ecs_primary_task_set} Resource
  *
  * @param scope The scope in which to define this construct
