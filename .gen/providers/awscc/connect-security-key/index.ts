// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/connect_security_key
...
export interface ConnectSecurityKeyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/connect_security_key#instance_id ConnectSecurityKey#instance_id}
  */
  readonly instanceId: string;
  /**
  * A valid security key in PEM format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/connect_security_key#key ConnectSecurityKey#key}
  */
  readonly key: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/connect_security_key awscc_connect_security_key}
*/
export class ConnectSecurityKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectSecurityKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/connect_security_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/connect_security_key awscc_connect_security_key} Resource
  *
  * @param scope The scope in which to define this construct
