// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task
...
export interface ResourcegroupsTagSyncTaskConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task#group ResourcegroupsTagSyncTask#group}
  */
  readonly group: string;
  /**
  * The Amazon resource name (ARN) of the role assumed by the service to tag and untag resources on your behalf.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task#role_arn ResourcegroupsTagSyncTask#role_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task#tag_key ResourcegroupsTagSyncTask#tag_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task#tag_value ResourcegroupsTagSyncTask#tag_value}
  */
  readonly tagValue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task awscc_resourcegroups_tag_sync_task}
*/
export class ResourcegroupsTagSyncTask extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcegroupsTagSyncTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/resourcegroups_tag_sync_task awscc_resourcegroups_tag_sync_task} Resource
  *
  * @param scope The scope in which to define this construct
