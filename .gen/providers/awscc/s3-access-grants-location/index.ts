// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location
...
export interface S3AccessGrantsLocationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location#iam_role_arn S3AccessGrantsLocation#iam_role_arn}
  */
  readonly iamRoleArn: string;
  /**
  * Descriptor for where the location actually points
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location#location_scope S3AccessGrantsLocation#location_scope}
  */
  readonly locationScope: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location#tags S3AccessGrantsLocation#tags}
  */
  readonly tags?: S3AccessGrantsLocationTags[] | cdktn.IResolvable;
}
export interface S3AccessGrantsLocationTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location#key S3AccessGrantsLocation#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location#value S3AccessGrantsLocation#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location awscc_s3_access_grants_location}
*/
export class S3AccessGrantsLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccessGrantsLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/s3_access_grants_location awscc_s3_access_grants_location} Resource
  *
  * @param scope The scope in which to define this construct
