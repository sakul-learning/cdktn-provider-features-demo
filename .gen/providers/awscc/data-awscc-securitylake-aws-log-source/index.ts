// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/securitylake_aws_log_source
...
export interface DataAwsccSecuritylakeAwsLogSourceConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/securitylake_aws_log_source#id DataAwsccSecuritylakeAwsLogSource#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/securitylake_aws_log_source awscc_securitylake_aws_log_source}
*/
export class DataAwsccSecuritylakeAwsLogSource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecuritylakeAwsLogSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/securitylake_aws_log_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/securitylake_aws_log_source awscc_securitylake_aws_log_source} Data Source
  *
  * @param scope The scope in which to define this construct
