// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store
...
export interface WorkspaceswebTrustStoreConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store#certificate_list WorkspaceswebTrustStore#certificate_list}
  */
  readonly certificateList: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store#tags WorkspaceswebTrustStore#tags}
  */
  readonly tags?: WorkspaceswebTrustStoreTags[] | cdktn.IResolvable;
}
export interface WorkspaceswebTrustStoreTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store#key WorkspaceswebTrustStore#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store#value WorkspaceswebTrustStore#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store awscc_workspacesweb_trust_store}
*/
export class WorkspaceswebTrustStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceswebTrustStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/workspacesweb_trust_store awscc_workspacesweb_trust_store} Resource
  *
  * @param scope The scope in which to define this construct
