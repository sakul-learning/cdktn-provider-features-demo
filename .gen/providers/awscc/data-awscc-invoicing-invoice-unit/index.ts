// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/invoicing_invoice_unit
...
export interface DataAwsccInvoicingInvoiceUnitConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/invoicing_invoice_unit#id DataAwsccInvoicingInvoiceUnit#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/invoicing_invoice_unit awscc_invoicing_invoice_unit}
*/
export class DataAwsccInvoicingInvoiceUnit extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccInvoicingInvoiceUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/invoicing_invoice_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/invoicing_invoice_unit awscc_invoicing_invoice_unit} Data Source
  *
  * @param scope The scope in which to define this construct
