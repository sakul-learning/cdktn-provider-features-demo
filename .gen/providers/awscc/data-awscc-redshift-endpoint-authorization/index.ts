// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/redshift_endpoint_authorization
...
export interface DataAwsccRedshiftEndpointAuthorizationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/redshift_endpoint_authorization#id DataAwsccRedshiftEndpointAuthorization#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/redshift_endpoint_authorization awscc_redshift_endpoint_authorization}
*/
export class DataAwsccRedshiftEndpointAuthorization extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRedshiftEndpointAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/redshift_endpoint_authorization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/redshift_endpoint_authorization awscc_redshift_endpoint_authorization} Data Source
  *
  * @param scope The scope in which to define this construct
