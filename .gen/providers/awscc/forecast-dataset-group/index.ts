// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group
...
export interface ForecastDatasetGroupConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#dataset_arns ForecastDatasetGroup#dataset_arns}
  */
  readonly datasetArns?: string[];
  /**
  * A name for the dataset group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#dataset_group_name ForecastDatasetGroup#dataset_group_name}
  */
  readonly datasetGroupName: string;
  /**
  * The domain associated with the dataset group. When you add a dataset to a dataset group, this value and the value specified for the Domain parameter of the CreateDataset operation must match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#domain ForecastDatasetGroup#domain}
  */
  readonly domain: string;
  /**
  * The tags of Application Insights application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#tags ForecastDatasetGroup#tags}
  */
...
export interface ForecastDatasetGroupTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#key ForecastDatasetGroup#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 0 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#value ForecastDatasetGroup#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group awscc_forecast_dataset_group}
*/
export class ForecastDatasetGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ForecastDatasetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/forecast_dataset_group awscc_forecast_dataset_group} Resource
  *
  * @param scope The scope in which to define this construct
