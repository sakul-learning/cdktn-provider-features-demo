// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/events_event_bus_policy
...
export interface DataAwsccEventsEventBusPolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/events_event_bus_policy#id DataAwsccEventsEventBusPolicy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/events_event_bus_policy awscc_events_event_bus_policy}
*/
export class DataAwsccEventsEventBusPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEventsEventBusPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/events_event_bus_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/events_event_bus_policy awscc_events_event_bus_policy} Data Source
  *
  * @param scope The scope in which to define this construct
