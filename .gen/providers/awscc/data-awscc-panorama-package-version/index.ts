// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/panorama_package_version
...
export interface DataAwsccPanoramaPackageVersionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/panorama_package_version#id DataAwsccPanoramaPackageVersion#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/panorama_package_version awscc_panorama_package_version}
*/
export class DataAwsccPanoramaPackageVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccPanoramaPackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/panorama_package_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/panorama_package_version awscc_panorama_package_version} Data Source
  *
  * @param scope The scope in which to define this construct
