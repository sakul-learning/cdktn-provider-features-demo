// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant
...
export interface WisdomAssistantConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#description WisdomAssistant#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#name WisdomAssistant#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#server_side_encryption_configuration WisdomAssistant#server_side_encryption_configuration}
  */
  readonly serverSideEncryptionConfiguration?: WisdomAssistantServerSideEncryptionConfiguration;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#tags WisdomAssistant#tags}
  */
  readonly tags?: WisdomAssistantTags[] | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#type WisdomAssistant#type}
  */
  readonly type: string;
}
export interface WisdomAssistantServerSideEncryptionConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#kms_key_id WisdomAssistant#kms_key_id}
  */
...
export interface WisdomAssistantTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#key WisdomAssistant#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#value WisdomAssistant#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant awscc_wisdom_assistant}
*/
export class WisdomAssistant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WisdomAssistant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/wisdom_assistant awscc_wisdom_assistant} Resource
  *
  * @param scope The scope in which to define this construct
