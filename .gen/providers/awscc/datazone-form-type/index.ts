// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type
...
export interface DatazoneFormTypeConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#description DatazoneFormType#description}
  */
  readonly description?: string;
  /**
  * The ID of the Amazon DataZone domain in which this metadata form type is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#domain_identifier DatazoneFormType#domain_identifier}
  */
  readonly domainIdentifier: string;
  /**
  * The model of this Amazon DataZone metadata form type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#model DatazoneFormType#model}
  */
  readonly model: DatazoneFormTypeModel;
  /**
  * The name of this Amazon DataZone metadata form type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#name DatazoneFormType#name}
  */
  readonly name: string;
  /**
  * The ID of the Amazon DataZone project that owns this metadata form type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#owning_project_identifier DatazoneFormType#owning_project_identifier}
  */
  readonly owningProjectIdentifier: string;
  /**
  * The status of this Amazon DataZone metadata form type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#status DatazoneFormType#status}
  */
  readonly status?: string;
}
export interface DatazoneFormTypeModel {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#smithy DatazoneFormType#smithy}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type awscc_datazone_form_type}
*/
export class DatazoneFormType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneFormType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/datazone_form_type awscc_datazone_form_type} Resource
  *
  * @param scope The scope in which to define this construct
