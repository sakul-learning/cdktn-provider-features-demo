// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/connect_approved_origin
...
export interface ConnectApprovedOriginConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/connect_approved_origin#instance_id ConnectApprovedOrigin#instance_id}
  */
  readonly instanceId: string;
  /**
  * Domain name to be added to the allowlist of instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/connect_approved_origin#origin ConnectApprovedOrigin#origin}
  */
  readonly origin: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/connect_approved_origin awscc_connect_approved_origin}
*/
export class ConnectApprovedOrigin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectApprovedOrigin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/connect_approved_origin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/connect_approved_origin awscc_connect_approved_origin} Resource
  *
  * @param scope The scope in which to define this construct
