// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule
...
export interface CloudwatchInsightRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#apply_on_transformed_logs CloudwatchInsightRule#apply_on_transformed_logs}
  */
  readonly applyOnTransformedLogs?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#rule_body CloudwatchInsightRule#rule_body}
  */
  readonly ruleBody: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#rule_name CloudwatchInsightRule#rule_name}
  */
  readonly ruleName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#rule_state CloudwatchInsightRule#rule_state}
  */
  readonly ruleState: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#tags CloudwatchInsightRule#tags}
  */
  readonly tags?: CloudwatchInsightRuleTags[] | cdktn.IResolvable;
}
export interface CloudwatchInsightRuleTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#key CloudwatchInsightRule#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#value CloudwatchInsightRule#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule awscc_cloudwatch_insight_rule}
*/
export class CloudwatchInsightRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchInsightRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/cloudwatch_insight_rule awscc_cloudwatch_insight_rule} Resource
  *
  * @param scope The scope in which to define this construct
