// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/s3tables_table_bucket
...
export interface DataAwsccS3TablesTableBucketConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/s3tables_table_bucket#id DataAwsccS3TablesTableBucket#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/s3tables_table_bucket awscc_s3tables_table_bucket}
*/
export class DataAwsccS3TablesTableBucket extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccS3TablesTableBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/s3tables_table_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/s3tables_table_bucket awscc_s3tables_table_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
