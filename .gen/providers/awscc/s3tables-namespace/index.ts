// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3tables_namespace
...
export interface S3TablesNamespaceConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3tables_namespace#namespace S3TablesNamespace#namespace}
  */
  readonly namespace: string;
  /**
  * The Amazon Resource Name (ARN) of the specified table bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3tables_namespace#table_bucket_arn S3TablesNamespace#table_bucket_arn}
  */
  readonly tableBucketArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3tables_namespace awscc_s3tables_namespace}
*/
export class S3TablesNamespace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3TablesNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3tables_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3tables_namespace awscc_s3tables_namespace} Resource
  *
  * @param scope The scope in which to define this construct
