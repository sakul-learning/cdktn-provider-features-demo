// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/msk_topic
...
export interface DataAwsccMskTopicConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/msk_topic#id DataAwsccMskTopic#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/msk_topic awscc_msk_topic}
*/
export class DataAwsccMskTopic extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMskTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/msk_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/msk_topic awscc_msk_topic} Data Source
  *
  * @param scope The scope in which to define this construct
