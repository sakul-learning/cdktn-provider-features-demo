// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl
...
export interface RolesanywhereCrlConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#crl_data RolesanywhereCrl#crl_data}
  */
  readonly crlData: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#enabled RolesanywhereCrl#enabled}
  */
  readonly enabled?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#name RolesanywhereCrl#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#tags RolesanywhereCrl#tags}
  */
  readonly tags?: RolesanywhereCrlTags[] | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#trust_anchor_arn RolesanywhereCrl#trust_anchor_arn}
  */
  readonly trustAnchorArn?: string;
}
export interface RolesanywhereCrlTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#key RolesanywhereCrl#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#value RolesanywhereCrl#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl awscc_rolesanywhere_crl}
*/
export class RolesanywhereCrl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RolesanywhereCrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/rolesanywhere_crl awscc_rolesanywhere_crl} Resource
  *
  * @param scope The scope in which to define this construct
