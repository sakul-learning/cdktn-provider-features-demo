// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/frauddetector_detectors
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/frauddetector_detectors awscc_frauddetector_detectors}
*/
export class DataAwsccFrauddetectorDetectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFrauddetectorDetectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/frauddetector_detectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/frauddetector_detectors awscc_frauddetector_detectors} Data Source
  *
  * @param scope The scope in which to define this construct
