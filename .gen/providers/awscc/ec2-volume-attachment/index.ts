// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment
...
export interface Ec2VolumeAttachmentConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment#device Ec2VolumeAttachment#device}
  */
  readonly device?: string;
  /**
  * The index of the EBS card. Some instance types support multiple EBS cards. The default EBS card index is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment#ebs_card_index Ec2VolumeAttachment#ebs_card_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment#instance_id Ec2VolumeAttachment#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment#volume_id Ec2VolumeAttachment#volume_id}
  */
  readonly volumeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment awscc_ec2_volume_attachment}
*/
export class Ec2VolumeAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VolumeAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_volume_attachment awscc_ec2_volume_attachment} Resource
  *
  * @param scope The scope in which to define this construct
