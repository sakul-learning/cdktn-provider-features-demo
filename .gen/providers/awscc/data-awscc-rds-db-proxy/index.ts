// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/rds_db_proxy
...
export interface DataAwsccRdsDbProxyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/rds_db_proxy#id DataAwsccRdsDbProxy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/rds_db_proxy awscc_rds_db_proxy}
*/
export class DataAwsccRdsDbProxy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccRdsDbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/rds_db_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/rds_db_proxy awscc_rds_db_proxy} Data Source
  *
  * @param scope The scope in which to define this construct
