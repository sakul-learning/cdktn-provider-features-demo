// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/ec2_ipam_pool_cidr
...
export interface DataAwsccEc2IpamPoolCidrConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/ec2_ipam_pool_cidr#id DataAwsccEc2IpamPoolCidr#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/ec2_ipam_pool_cidr awscc_ec2_ipam_pool_cidr}
*/
export class DataAwsccEc2IpamPoolCidr extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2IpamPoolCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/ec2_ipam_pool_cidr#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/ec2_ipam_pool_cidr awscc_ec2_ipam_pool_cidr} Data Source
  *
  * @param scope The scope in which to define this construct
