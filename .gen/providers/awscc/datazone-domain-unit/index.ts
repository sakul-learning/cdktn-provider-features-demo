// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit
...
export interface DatazoneDomainUnitConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit#description DatazoneDomainUnit#description}
  */
  readonly description?: string;
  /**
  * The ID of the domain where you want to create a domain unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit#domain_identifier DatazoneDomainUnit#domain_identifier}
  */
  readonly domainIdentifier: string;
  /**
  * The name of the domain unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit#name DatazoneDomainUnit#name}
  */
  readonly name: string;
  /**
  * The ID of the parent domain unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit#parent_domain_unit_identifier DatazoneDomainUnit#parent_domain_unit_identifier}
  */
  readonly parentDomainUnitIdentifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit awscc_datazone_domain_unit}
*/
export class DatazoneDomainUnit extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneDomainUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/datazone_domain_unit awscc_datazone_domain_unit} Resource
  *
  * @param scope The scope in which to define this construct
