// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/guardduty_member
...
export interface DataAwsccGuarddutyMemberConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/guardduty_member#id DataAwsccGuarddutyMember#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/guardduty_member awscc_guardduty_member}
*/
export class DataAwsccGuarddutyMember extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccGuarddutyMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/guardduty_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/guardduty_member awscc_guardduty_member} Data Source
  *
  * @param scope The scope in which to define this construct
