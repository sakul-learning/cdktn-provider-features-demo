// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ecr_registry_policy
...
export interface EcrRegistryPolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ecr_registry_policy#policy_text EcrRegistryPolicy#policy_text}
  */
  readonly policyText: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ecr_registry_policy awscc_ecr_registry_policy}
*/
export class EcrRegistryPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrRegistryPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ecr_registry_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ecr_registry_policy awscc_ecr_registry_policy} Resource
  *
  * @param scope The scope in which to define this construct
