// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecr_pull_time_update_exclusion
...
export interface EcrPullTimeUpdateExclusionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecr_pull_time_update_exclusion#principal_arn EcrPullTimeUpdateExclusion#principal_arn}
  */
  readonly principalArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecr_pull_time_update_exclusion awscc_ecr_pull_time_update_exclusion}
*/
export class EcrPullTimeUpdateExclusion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrPullTimeUpdateExclusion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecr_pull_time_update_exclusion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ecr_pull_time_update_exclusion awscc_ecr_pull_time_update_exclusion} Resource
  *
  * @param scope The scope in which to define this construct
