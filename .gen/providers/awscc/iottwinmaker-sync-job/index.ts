// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job
...
export interface IottwinmakerSyncJobConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job#sync_role IottwinmakerSyncJob#sync_role}
  */
  readonly syncRole: string;
  /**
  * The source of the SyncJob.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job#sync_source IottwinmakerSyncJob#sync_source}
  */
  readonly syncSource: string;
  /**
  * A key-value pair to associate with a resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job#tags IottwinmakerSyncJob#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The ID of the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job#workspace_id IottwinmakerSyncJob#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job awscc_iottwinmaker_sync_job}
*/
export class IottwinmakerSyncJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IottwinmakerSyncJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/iottwinmaker_sync_job awscc_iottwinmaker_sync_job} Resource
  *
  * @param scope The scope in which to define this construct
