// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type
...
export interface CassandraTypeConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type#fields CassandraType#fields}
  */
  readonly fields: CassandraTypeFields[] | cdktn.IResolvable;
  /**
  * Name of the Keyspace which contains the User-Defined Type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type#keyspace_name CassandraType#keyspace_name}
  */
  readonly keyspaceName: string;
  /**
  * Name of the User-Defined Type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type#type_name CassandraType#type_name}
  */
  readonly typeName: string;
}
export interface CassandraTypeFields {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type#field_name CassandraType#field_name}
  */
  readonly fieldName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type#field_type CassandraType#field_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type awscc_cassandra_type}
*/
export class CassandraType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CassandraType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/cassandra_type awscc_cassandra_type} Resource
  *
  * @param scope The scope in which to define this construct
