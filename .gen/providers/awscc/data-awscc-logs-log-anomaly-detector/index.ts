// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/logs_log_anomaly_detector
...
export interface DataAwsccLogsLogAnomalyDetectorConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/logs_log_anomaly_detector#id DataAwsccLogsLogAnomalyDetector#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/logs_log_anomaly_detector awscc_logs_log_anomaly_detector}
*/
export class DataAwsccLogsLogAnomalyDetector extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLogsLogAnomalyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/logs_log_anomaly_detector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/logs_log_anomaly_detector awscc_logs_log_anomaly_detector} Data Source
  *
  * @param scope The scope in which to define this construct
