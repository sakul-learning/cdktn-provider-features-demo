// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_security_group_ingress
...
export interface DataAwsccEc2SecurityGroupIngressConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_security_group_ingress#id DataAwsccEc2SecurityGroupIngress#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_security_group_ingress awscc_ec2_security_group_ingress}
*/
export class DataAwsccEc2SecurityGroupIngress extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccEc2SecurityGroupIngress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_security_group_ingress#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/ec2_security_group_ingress awscc_ec2_security_group_ingress} Data Source
  *
  * @param scope The scope in which to define this construct
