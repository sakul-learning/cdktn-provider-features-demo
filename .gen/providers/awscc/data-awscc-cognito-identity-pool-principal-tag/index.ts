// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/cognito_identity_pool_principal_tag
...
export interface DataAwsccCognitoIdentityPoolPrincipalTagConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/cognito_identity_pool_principal_tag#id DataAwsccCognitoIdentityPoolPrincipalTag#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/cognito_identity_pool_principal_tag awscc_cognito_identity_pool_principal_tag}
*/
export class DataAwsccCognitoIdentityPoolPrincipalTag extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCognitoIdentityPoolPrincipalTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/cognito_identity_pool_principal_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/cognito_identity_pool_principal_tag awscc_cognito_identity_pool_principal_tag} Data Source
  *
  * @param scope The scope in which to define this construct
