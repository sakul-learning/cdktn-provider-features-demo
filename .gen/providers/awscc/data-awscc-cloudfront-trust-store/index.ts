// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cloudfront_trust_store
...
export interface DataAwsccCloudfrontTrustStoreConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cloudfront_trust_store#id DataAwsccCloudfrontTrustStore#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cloudfront_trust_store awscc_cloudfront_trust_store}
*/
export class DataAwsccCloudfrontTrustStore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccCloudfrontTrustStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cloudfront_trust_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/cloudfront_trust_store awscc_cloudfront_trust_store} Data Source
  *
  * @param scope The scope in which to define this construct
