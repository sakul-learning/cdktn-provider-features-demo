// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/voiceid_domains
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/voiceid_domains awscc_voiceid_domains}
*/
export class DataAwsccVoiceidDomains extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccVoiceidDomains that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/voiceid_domains#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/voiceid_domains awscc_voiceid_domains} Data Source
  *
  * @param scope The scope in which to define this construct
