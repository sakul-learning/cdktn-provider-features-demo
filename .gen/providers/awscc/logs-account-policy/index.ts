// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy
...
export interface LogsAccountPolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy#policy_document LogsAccountPolicy#policy_document}
  */
  readonly policyDocument: string;
  /**
  * The name of the account policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy#policy_name LogsAccountPolicy#policy_name}
  */
  readonly policyName: string;
  /**
  * Type of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy#policy_type LogsAccountPolicy#policy_type}
  */
  readonly policyType: string;
  /**
  * Scope for policy application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy#scope LogsAccountPolicy#scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy#selection_criteria LogsAccountPolicy#selection_criteria}
  */
  readonly selectionCriteria?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy awscc_logs_account_policy}
*/
export class LogsAccountPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsAccountPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/logs_account_policy awscc_logs_account_policy} Resource
  *
  * @param scope The scope in which to define this construct
