// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_certificate
...
export interface DataAwsccIotCertificateConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_certificate#id DataAwsccIotCertificate#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_certificate awscc_iot_certificate}
*/
export class DataAwsccIotCertificate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iot_certificate awscc_iot_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
