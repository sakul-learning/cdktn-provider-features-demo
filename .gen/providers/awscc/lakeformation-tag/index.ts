// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag
...
export interface LakeformationTagConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag#catalog_id LakeformationTag#catalog_id}
  */
  readonly catalogId?: string;
  /**
  * The key-name for the LF-tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag#tag_key LakeformationTag#tag_key}
  */
  readonly tagKey: string;
  /**
  * A list of possible values an attribute can take.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag#tag_values LakeformationTag#tag_values}
  */
  readonly tagValues: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag awscc_lakeformation_tag}
*/
export class LakeformationTag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LakeformationTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/lakeformation_tag awscc_lakeformation_tag} Resource
  *
  * @param scope The scope in which to define this construct
