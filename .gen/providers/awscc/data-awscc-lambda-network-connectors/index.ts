// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_network_connectors
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_network_connectors awscc_lambda_network_connectors}
*/
export class DataAwsccLambdaNetworkConnectors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLambdaNetworkConnectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_network_connectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_network_connectors awscc_lambda_network_connectors} Data Source
  *
  * @param scope The scope in which to define this construct
