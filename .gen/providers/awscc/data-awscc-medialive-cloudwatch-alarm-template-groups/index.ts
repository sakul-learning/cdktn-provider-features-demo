// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/medialive_cloudwatch_alarm_template_groups
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/medialive_cloudwatch_alarm_template_groups awscc_medialive_cloudwatch_alarm_template_groups}
*/
export class DataAwsccMedialiveCloudwatchAlarmTemplateGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMedialiveCloudwatchAlarmTemplateGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/medialive_cloudwatch_alarm_template_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/medialive_cloudwatch_alarm_template_groups awscc_medialive_cloudwatch_alarm_template_groups} Data Source
  *
  * @param scope The scope in which to define this construct
