// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile
...
export interface IamInstanceProfileConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile#instance_profile_name IamInstanceProfile#instance_profile_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile#path IamInstanceProfile#path}
  */
  readonly path?: string;
  /**
  * The name of the role to associate with the instance profile. Only one role can be assigned to an EC2 instance at a time, and all applications on the instance share the same role and permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile#roles IamInstanceProfile#roles}
  */
  readonly roles: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile awscc_iam_instance_profile}
*/
export class IamInstanceProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/iam_instance_profile awscc_iam_instance_profile} Resource
  *
  * @param scope The scope in which to define this construct
