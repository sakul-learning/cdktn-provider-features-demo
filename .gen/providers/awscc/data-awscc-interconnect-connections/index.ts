// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/interconnect_connections
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/interconnect_connections awscc_interconnect_connections}
*/
export class DataAwsccInterconnectConnections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccInterconnectConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/interconnect_connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/interconnect_connections awscc_interconnect_connections} Data Source
  *
  * @param scope The scope in which to define this construct
