// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository
...
export interface CodeartifactRepositoryConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#description CodeartifactRepository#description}
  */
  readonly description?: string;
  /**
  * The name of the domain that contains the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#domain_name CodeartifactRepository#domain_name}
  */
  readonly domainName: string;
  /**
  * A list of external connections associated with the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#external_connections CodeartifactRepository#external_connections}
  */
  readonly externalConnections?: string[];
  /**
  * The access control resource policy on the provided repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#permissions_policy_document CodeartifactRepository#permissions_policy_document}
  */
  readonly permissionsPolicyDocument?: string;
  /**
  * The name of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#repository_name CodeartifactRepository#repository_name}
  */
  readonly repositoryName: string;
  /**
  * An array of key-value pairs to apply to this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#tags CodeartifactRepository#tags}
  */
  readonly tags?: CodeartifactRepositoryTags[] | cdktn.IResolvable;
  /**
  * A list of upstream repositories associated with the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#upstreams CodeartifactRepository#upstreams}
  */
...
export interface CodeartifactRepositoryTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#key CodeartifactRepository#key}
  */
  readonly key?: string;
  /**
  * The value for the tag. You can specify a value that is 1 to 256 Unicode characters in length and cannot be prefixed with aws:. You can use any of the following characters: the set of Unicode letters, digits, whitespace, _, ., /, =, +, and -. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#value CodeartifactRepository#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository awscc_codeartifact_repository}
*/
export class CodeartifactRepository extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeartifactRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/codeartifact_repository awscc_codeartifact_repository} Resource
  *
  * @param scope The scope in which to define this construct
