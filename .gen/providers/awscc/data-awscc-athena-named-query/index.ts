// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/athena_named_query
...
export interface DataAwsccAthenaNamedQueryConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/athena_named_query#id DataAwsccAthenaNamedQuery#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/athena_named_query awscc_athena_named_query}
*/
export class DataAwsccAthenaNamedQuery extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAthenaNamedQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/athena_named_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/athena_named_query awscc_athena_named_query} Data Source
  *
  * @param scope The scope in which to define this construct
