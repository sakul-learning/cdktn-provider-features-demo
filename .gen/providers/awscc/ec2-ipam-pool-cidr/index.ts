// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr
...
export interface Ec2IpamPoolCidrConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr#cidr Ec2IpamPoolCidr#cidr}
  */
  readonly cidr?: string;
  /**
  * Id of the IPAM Pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr#ipam_pool_id Ec2IpamPoolCidr#ipam_pool_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr#netmask_length Ec2IpamPoolCidr#netmask_length}
  */
  readonly netmaskLength?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr awscc_ec2_ipam_pool_cidr}
*/
export class Ec2IpamPoolCidr extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2IpamPoolCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_ipam_pool_cidr awscc_ec2_ipam_pool_cidr} Resource
  *
  * @param scope The scope in which to define this construct
