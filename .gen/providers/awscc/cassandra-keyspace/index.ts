// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace
...
export interface CassandraKeyspaceConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#client_side_timestamps_enabled CassandraKeyspace#client_side_timestamps_enabled}
  */
  readonly clientSideTimestampsEnabled?: boolean | cdktn.IResolvable;
  /**
  * Name for Cassandra keyspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#keyspace_name CassandraKeyspace#keyspace_name}
  */
  readonly keyspaceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#replication_specification CassandraKeyspace#replication_specification}
  */
  readonly replicationSpecification?: CassandraKeyspaceReplicationSpecification;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#tags CassandraKeyspace#tags}
  */
  readonly tags?: CassandraKeyspaceTags[] | cdktn.IResolvable;
}
export interface CassandraKeyspaceReplicationSpecification {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#region_list CassandraKeyspace#region_list}
  */
  readonly regionList?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#replication_strategy CassandraKeyspace#replication_strategy}
  */
...
export interface CassandraKeyspaceTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#key CassandraKeyspace#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#value CassandraKeyspace#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace awscc_cassandra_keyspace}
*/
export class CassandraKeyspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CassandraKeyspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/cassandra_keyspace awscc_cassandra_keyspace} Resource
  *
  * @param scope The scope in which to define this construct
