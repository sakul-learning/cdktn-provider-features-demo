// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/shield_drt_access
...
export interface ShieldDrtAccessConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/shield_drt_access#log_bucket_list ShieldDrtAccess#log_bucket_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/shield_drt_access#role_arn ShieldDrtAccess#role_arn}
  */
  readonly roleArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/shield_drt_access awscc_shield_drt_access}
*/
export class ShieldDrtAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldDrtAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/shield_drt_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/shield_drt_access awscc_shield_drt_access} Resource
  *
  * @param scope The scope in which to define this construct
