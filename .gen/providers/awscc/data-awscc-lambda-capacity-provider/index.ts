// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_capacity_provider
...
export interface DataAwsccLambdaCapacityProviderConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_capacity_provider#id DataAwsccLambdaCapacityProvider#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_capacity_provider awscc_lambda_capacity_provider}
*/
export class DataAwsccLambdaCapacityProvider extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLambdaCapacityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_capacity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/lambda_capacity_provider awscc_lambda_capacity_provider} Data Source
  *
  * @param scope The scope in which to define this construct
