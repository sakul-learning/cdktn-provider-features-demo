// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/vpclattice_auth_policy
...
export interface VpclatticeAuthPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/vpclattice_auth_policy#policy VpclatticeAuthPolicy#policy}
  */
  readonly policy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/vpclattice_auth_policy#resource_identifier VpclatticeAuthPolicy#resource_identifier}
  */
  readonly resourceIdentifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/vpclattice_auth_policy awscc_vpclattice_auth_policy}
*/
export class VpclatticeAuthPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeAuthPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/vpclattice_auth_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/vpclattice_auth_policy awscc_vpclattice_auth_policy} Resource
  *
  * @param scope The scope in which to define this construct
