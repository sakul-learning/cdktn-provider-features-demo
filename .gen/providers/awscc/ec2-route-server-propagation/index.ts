// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_route_server_propagation
...
export interface Ec2RouteServerPropagationConfig extends cdktn.TerraformMetaArguments {
  ...
  * Route Server ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_route_server_propagation#route_server_id Ec2RouteServerPropagation#route_server_id}
  */
  readonly routeServerId: string;
  /**
  * Route Table ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_route_server_propagation#route_table_id Ec2RouteServerPropagation#route_table_id}
  */
  readonly routeTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_route_server_propagation awscc_ec2_route_server_propagation}
*/
export class Ec2RouteServerPropagation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2RouteServerPropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_route_server_propagation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/ec2_route_server_propagation awscc_ec2_route_server_propagation} Resource
  *
  * @param scope The scope in which to define this construct
