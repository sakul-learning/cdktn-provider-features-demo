// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/batch_job_queue
...
export interface DataAwsccBatchJobQueueConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/batch_job_queue#id DataAwsccBatchJobQueue#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/batch_job_queue awscc_batch_job_queue}
*/
export class DataAwsccBatchJobQueue extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccBatchJobQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/batch_job_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/batch_job_queue awscc_batch_job_queue} Data Source
  *
  * @param scope The scope in which to define this construct
