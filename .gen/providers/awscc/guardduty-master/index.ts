// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master
...
export interface GuarddutyMasterConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master#detector_id GuarddutyMaster#detector_id}
  */
  readonly detectorId: string;
  /**
  * Value used to validate the master account to the member account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master#invitation_id GuarddutyMaster#invitation_id}
  */
  readonly invitationId?: string;
  /**
  * ID of the account used as the master account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master#master_id GuarddutyMaster#master_id}
  */
  readonly masterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master awscc_guardduty_master}
*/
export class GuarddutyMaster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyMaster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/guardduty_master awscc_guardduty_master} Resource
  *
  * @param scope The scope in which to define this construct
