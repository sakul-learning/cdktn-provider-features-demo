// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2
...
export interface SecurityhubAggregatorV2Config extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2#linked_regions SecurityhubAggregatorV2#linked_regions}
  */
  readonly linkedRegions: string[];
  /**
  * Indicates to link a list of included Regions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2#region_linking_mode SecurityhubAggregatorV2#region_linking_mode}
  */
  readonly regionLinkingMode: string;
  /**
  * A key-value pair to associate with the Security Hub V2 resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2#tags SecurityhubAggregatorV2#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2 awscc_securityhub_aggregator_v2}
*/
export class SecurityhubAggregatorV2 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityhubAggregatorV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_aggregator_v2 awscc_securityhub_aggregator_v2} Resource
  *
  * @param scope The scope in which to define this construct
