// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/apigateway_domain_name
...
export interface DataAwsccApigatewayDomainNameConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/apigateway_domain_name#id DataAwsccApigatewayDomainName#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/apigateway_domain_name awscc_apigateway_domain_name}
*/
export class DataAwsccApigatewayDomainName extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccApigatewayDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/apigateway_domain_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/apigateway_domain_name awscc_apigateway_domain_name} Data Source
  *
  * @param scope The scope in which to define this construct
