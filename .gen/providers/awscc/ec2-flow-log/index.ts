// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log
...
export interface Ec2FlowLogConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#deliver_cross_account_role Ec2FlowLog#deliver_cross_account_role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#deliver_logs_permission_arn Ec2FlowLog#deliver_logs_permission_arn}
  */
  readonly deliverLogsPermissionArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#destination_options Ec2FlowLog#destination_options}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#log_destination Ec2FlowLog#log_destination}
  */
  readonly logDestination?: string;
  /**
  * Specifies the type of destination to which the flow log data is to be published. Flow log data can be published to CloudWatch Logs or Amazon S3.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#log_destination_type Ec2FlowLog#log_destination_type}
  */
  readonly logDestinationType?: string;
  /**
  * The fields to include in the flow log record, in the order in which they should appear.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#log_format Ec2FlowLog#log_format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#log_group_name Ec2FlowLog#log_group_name}
  */
  readonly logGroupName?: string;
  /**
  * The maximum interval of time during which a flow of packets is captured and aggregated into a flow log record. You can specify 60 seconds (1 minute) or 600 seconds (10 minutes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#max_aggregation_interval Ec2FlowLog#max_aggregation_interval}
  */
  readonly maxAggregationInterval?: number;
  /**
  * The ID of the subnet, network interface, or VPC for which you want to create a flow log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#resource_id Ec2FlowLog#resource_id}
  */
  readonly resourceId: string;
  /**
  * The type of resource for which to create the flow log. For example, if you specified a VPC ID for the ResourceId property, specify VPC for this property.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#resource_type Ec2FlowLog#resource_type}
  */
  readonly resourceType: string;
  /**
  * The resource types and associated tags for EC2 resources associated with the EC2 Tags feature for log enrichment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#tag_field_specifications Ec2FlowLog#tag_field_specifications}
  */
  readonly tagFieldSpecifications?: Ec2FlowLogTagFieldSpecifications[] | cdktn.IResolvable;
  /**
  * The tags to apply to the flow logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#tags Ec2FlowLog#tags}
  */
  readonly tags?: Ec2FlowLogTags[] | cdktn.IResolvable;
  /**
  * The type of traffic to log. You can log traffic that the resource accepts or rejects, or all traffic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#traffic_type Ec2FlowLog#traffic_type}
  */
  readonly trafficType?: string;
}
export interface Ec2FlowLogDestinationOptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#file_format Ec2FlowLog#file_format}
  */
  readonly fileFormat?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#hive_compatible_partitions Ec2FlowLog#hive_compatible_partitions}
  */
  readonly hiveCompatiblePartitions?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#per_hour_partition Ec2FlowLog#per_hour_partition}
  */
...
export interface Ec2FlowLogTagFieldSpecifications {
  ...
  */
  readonly resourceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#tag_keys Ec2FlowLog#tag_keys}
  */
...
export interface Ec2FlowLogTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#key Ec2FlowLog#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#value Ec2FlowLog#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log awscc_ec2_flow_log}
*/
export class Ec2FlowLog extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2FlowLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_flow_log awscc_ec2_flow_log} Resource
  *
  * @param scope The scope in which to define this construct
