// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/fms_notification_channel
...
export interface DataAwsccFmsNotificationChannelConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/fms_notification_channel#id DataAwsccFmsNotificationChannel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/fms_notification_channel awscc_fms_notification_channel}
*/
export class DataAwsccFmsNotificationChannel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccFmsNotificationChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/fms_notification_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/fms_notification_channel awscc_fms_notification_channel} Data Source
  *
  * @param scope The scope in which to define this construct
