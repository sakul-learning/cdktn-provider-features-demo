// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_delegated_admin
...
export interface DataAwsccSecurityhubDelegatedAdminConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_delegated_admin#id DataAwsccSecurityhubDelegatedAdmin#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_delegated_admin awscc_securityhub_delegated_admin}
*/
export class DataAwsccSecurityhubDelegatedAdmin extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubDelegatedAdmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_delegated_admin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_delegated_admin awscc_securityhub_delegated_admin} Data Source
  *
  * @param scope The scope in which to define this construct
