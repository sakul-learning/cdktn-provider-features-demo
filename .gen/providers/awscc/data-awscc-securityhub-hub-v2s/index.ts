// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_hub_v2s
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_hub_v2s awscc_securityhub_hub_v2s}
*/
export class DataAwsccSecurityhubHubV2S extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccSecurityhubHubV2S that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_hub_v2s#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/securityhub_hub_v2s awscc_securityhub_hub_v2s} Data Source
  *
  * @param scope The scope in which to define this construct
