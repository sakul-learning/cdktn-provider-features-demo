// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/aiops_investigation_group
...
export interface DataAwsccAiopsInvestigationGroupConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/aiops_investigation_group#id DataAwsccAiopsInvestigationGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/aiops_investigation_group awscc_aiops_investigation_group}
*/
export class DataAwsccAiopsInvestigationGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccAiopsInvestigationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/aiops_investigation_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/aiops_investigation_group awscc_aiops_investigation_group} Data Source
  *
  * @param scope The scope in which to define this construct
