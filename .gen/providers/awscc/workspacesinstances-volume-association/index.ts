// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association
...
export interface WorkspacesinstancesVolumeAssociationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association#device WorkspacesinstancesVolumeAssociation#device}
  */
  readonly device: string;
  /**
  * Mode to use when disassociating the volume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association#disassociate_mode WorkspacesinstancesVolumeAssociation#disassociate_mode}
  */
  readonly disassociateMode?: string;
  /**
  * ID of the volume to attach to the workspace instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association#volume_id WorkspacesinstancesVolumeAssociation#volume_id}
  */
  readonly volumeId: string;
  /**
  * ID of the workspace instance to associate with the volume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association#workspace_instance_id WorkspacesinstancesVolumeAssociation#workspace_instance_id}
  */
  readonly workspaceInstanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association awscc_workspacesinstances_volume_association}
*/
export class WorkspacesinstancesVolumeAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspacesinstancesVolumeAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/workspacesinstances_volume_association awscc_workspacesinstances_volume_association} Resource
  *
  * @param scope The scope in which to define this construct
