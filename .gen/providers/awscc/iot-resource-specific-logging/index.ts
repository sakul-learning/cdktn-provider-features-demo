// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging
...
export interface IotResourceSpecificLoggingConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging#log_level IotResourceSpecificLogging#log_level}
  */
  readonly logLevel: string;
  /**
  * The target name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging#target_name IotResourceSpecificLogging#target_name}
  */
  readonly targetName: string;
  /**
  * The target type. Value must be THING_GROUP, CLIENT_ID, SOURCE_IP, PRINCIPAL_ID, or EVENT_TYPE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging#target_type IotResourceSpecificLogging#target_type}
  */
  readonly targetType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging awscc_iot_resource_specific_logging}
*/
export class IotResourceSpecificLogging extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotResourceSpecificLogging that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/iot_resource_specific_logging awscc_iot_resource_specific_logging} Resource
  *
  * @param scope The scope in which to define this construct
