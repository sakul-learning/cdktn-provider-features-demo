// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription
...
export interface CeAnomalySubscriptionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#frequency CeAnomalySubscription#frequency}
  */
  readonly frequency: string;
  /**
  * A list of cost anomaly monitors.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#monitor_arn_list CeAnomalySubscription#monitor_arn_list}
  */
  readonly monitorArnList: string[];
  /**
  * Tags to assign to subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#resource_tags CeAnomalySubscription#resource_tags}
  */
  readonly resourceTags?: CeAnomalySubscriptionResourceTags[] | cdktn.IResolvable;
  /**
  * A list of subscriber
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#subscribers CeAnomalySubscription#subscribers}
  */
  readonly subscribers: CeAnomalySubscriptionSubscribers[] | cdktn.IResolvable;
  /**
  * The name of the subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#subscription_name CeAnomalySubscription#subscription_name}
  */
  readonly subscriptionName: string;
  /**
  * The dollar value that triggers a notification if the threshold is exceeded. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#threshold CeAnomalySubscription#threshold}
  */
  readonly threshold?: number;
  /**
  * An Expression object in JSON String format used to specify the anomalies that you want to generate alerts for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#threshold_expression CeAnomalySubscription#threshold_expression}
  */
...
export interface CeAnomalySubscriptionResourceTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#key CeAnomalySubscription#key}
  */
  readonly key?: string;
  /**
  * The value for the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#value CeAnomalySubscription#value}
  */
...
export interface CeAnomalySubscriptionSubscribers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#address CeAnomalySubscription#address}
  */
  readonly address: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#status CeAnomalySubscription#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#type CeAnomalySubscription#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription awscc_ce_anomaly_subscription}
*/
export class CeAnomalySubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CeAnomalySubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/ce_anomaly_subscription awscc_ce_anomaly_subscription} Resource
  *
  * @param scope The scope in which to define this construct
