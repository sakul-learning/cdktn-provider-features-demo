// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/lightsail_static_ip
...
export interface LightsailStaticIpConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/lightsail_static_ip#attached_to LightsailStaticIp#attached_to}
  */
  readonly attachedTo?: string;
  /**
  * The name of the static IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/lightsail_static_ip#static_ip_name LightsailStaticIp#static_ip_name}
  */
  readonly staticIpName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/lightsail_static_ip awscc_lightsail_static_ip}
*/
export class LightsailStaticIp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailStaticIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/lightsail_static_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/lightsail_static_ip awscc_lightsail_static_ip} Resource
  *
  * @param scope The scope in which to define this construct
