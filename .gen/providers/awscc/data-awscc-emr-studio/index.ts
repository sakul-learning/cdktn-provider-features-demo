// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/emr_studio
...
export interface DataAwsccEmrStudioConfig extends cdktn.TerraformMetaArguments {
  /**
  * Uniquely identifies the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/emr_studio#id DataAwsccEmrStudio#id}
  *
...
export interface DataAwsccEmrStudioTags {
}
...
export function dataAwsccEmrStudioTagsToHclTerraform(struct?: DataAwsccEmrStudioTags): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsccEmrStudioTagsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsccEmrStudioTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsccEmrStudioTags | undefined) {
    if (value === undefined) {
...
export class DataAwsccEmrStudioTagsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsccEmrStudioTagsOutputReference {
    return new DataAwsccEmrStudioTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/emr_studio awscc_emr_studio}
*/
export class DataAwsccEmrStudio extends cdktn.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAwsccEmrStudio to import
  * @param importFromId The id of the existing DataAwsccEmrStudio that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/emr_studio#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAwsccEmrStudio to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/emr_studio awscc_emr_studio} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // idc_user_assignment - computed: true, optional: false, required: false
  public get idcUserAssignment() {
    return this.getStringAttribute('idc_user_assignment');
  }

  // idp_auth_url - computed: true, optional: false, required: false
  public get idpAuthUrl() {
    return this.getStringAttribute('idp_auth_url');
  }

  // idp_relay_state_parameter_name - computed: true, optional: false, required: false
  ...
  private _tags = new DataAwsccEmrStudioTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }

  // trusted_identity_propagation_enabled - computed: true, optional: false, required: false
