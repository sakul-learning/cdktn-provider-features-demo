// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/lambda_permission
...
export interface DataAwsccLambdaPermissionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/lambda_permission#id DataAwsccLambdaPermission#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/lambda_permission awscc_lambda_permission}
*/
export class DataAwsccLambdaPermission extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLambdaPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/lambda_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/data-sources/lambda_permission awscc_lambda_permission} Data Source
  *
  * @param scope The scope in which to define this construct
