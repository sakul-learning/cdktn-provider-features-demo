// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/mediatailor_channel_policy
...
export interface MediatailorChannelPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/mediatailor_channel_policy#channel_name MediatailorChannelPolicy#channel_name}
  */
  readonly channelName: string;
  /**
  * <p>The IAM policy for the channel. IAM policies are used to control access to your channel.</p>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/mediatailor_channel_policy#policy MediatailorChannelPolicy#policy}
  */
  readonly policy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/mediatailor_channel_policy awscc_mediatailor_channel_policy}
*/
export class MediatailorChannelPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediatailorChannelPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/mediatailor_channel_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/mediatailor_channel_policy awscc_mediatailor_channel_policy} Resource
  *
  * @param scope The scope in which to define this construct
