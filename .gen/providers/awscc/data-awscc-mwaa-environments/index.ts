// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/mwaa_environments
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/mwaa_environments awscc_mwaa_environments}
*/
export class DataAwsccMwaaEnvironments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMwaaEnvironments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/mwaa_environments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/mwaa_environments awscc_mwaa_environments} Data Source
  *
  * @param scope The scope in which to define this construct
