// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_delegated_admin
...
export interface SecurityhubDelegatedAdminConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_delegated_admin#admin_account_id SecurityhubDelegatedAdmin#admin_account_id}
  */
  readonly adminAccountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_delegated_admin awscc_securityhub_delegated_admin}
*/
export class SecurityhubDelegatedAdmin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityhubDelegatedAdmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_delegated_admin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/securityhub_delegated_admin awscc_securityhub_delegated_admin} Resource
  *
  * @param scope The scope in which to define this construct
