// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/directconnect_connection
...
export interface DataAwsccDirectconnectConnectionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/directconnect_connection#id DataAwsccDirectconnectConnection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/directconnect_connection awscc_directconnect_connection}
*/
export class DataAwsccDirectconnectConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccDirectconnectConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/directconnect_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/directconnect_connection awscc_directconnect_connection} Data Source
  *
  * @param scope The scope in which to define this construct
