// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_disks
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_disks awscc_lightsail_disks}
*/
export class DataAwsccLightsailDisks extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccLightsailDisks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_disks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/lightsail_disks awscc_lightsail_disks} Data Source
  *
  * @param scope The scope in which to define this construct
