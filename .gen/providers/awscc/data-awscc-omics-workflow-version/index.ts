// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_workflow_version
...
export interface DataAwsccOmicsWorkflowVersionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_workflow_version#id DataAwsccOmicsWorkflowVersion#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_workflow_version awscc_omics_workflow_version}
*/
export class DataAwsccOmicsWorkflowVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccOmicsWorkflowVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_workflow_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/omics_workflow_version awscc_omics_workflow_version} Data Source
  *
  * @param scope The scope in which to define this construct
