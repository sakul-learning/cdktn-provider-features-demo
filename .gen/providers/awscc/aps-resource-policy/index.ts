// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/aps_resource_policy
...
export interface ApsResourcePolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/aps_resource_policy#policy_document ApsResourcePolicy#policy_document}
  */
  readonly policyDocument: string;
  /**
  * The Arn of an APS Workspace that the PolicyDocument will be attached to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/aps_resource_policy#workspace_arn ApsResourcePolicy#workspace_arn}
  */
  readonly workspaceArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/aps_resource_policy awscc_aps_resource_policy}
*/
export class ApsResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApsResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/aps_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/aps_resource_policy awscc_aps_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
