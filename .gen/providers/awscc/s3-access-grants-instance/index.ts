// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance
...
export interface S3AccessGrantsInstanceConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance#identity_center_arn S3AccessGrantsInstance#identity_center_arn}
  */
  readonly identityCenterArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance#tags S3AccessGrantsInstance#tags}
  */
  readonly tags?: S3AccessGrantsInstanceTags[] | cdktn.IResolvable;
}
export interface S3AccessGrantsInstanceTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance#key S3AccessGrantsInstance#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance#value S3AccessGrantsInstance#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance awscc_s3_access_grants_instance}
*/
export class S3AccessGrantsInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccessGrantsInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/s3_access_grants_instance awscc_s3_access_grants_instance} Resource
  *
  * @param scope The scope in which to define this construct
