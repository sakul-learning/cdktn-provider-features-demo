// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table
...
export interface Ec2RouteTableConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table#tags Ec2RouteTable#tags}
  */
  readonly tags?: Ec2RouteTableTags[] | cdktn.IResolvable;
  /**
  * The ID of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table#vpc_id Ec2RouteTable#vpc_id}
  */
...
export interface Ec2RouteTableTags {
  ...
  * The tag key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table#key Ec2RouteTable#key}
  */
  readonly key?: string;
  /**
  * The tag value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table#value Ec2RouteTable#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table awscc_ec2_route_table}
*/
export class Ec2RouteTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2RouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/resources/ec2_route_table awscc_ec2_route_table} Resource
  *
  * @param scope The scope in which to define this construct
