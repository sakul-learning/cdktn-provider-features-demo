// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/iotsitewise_gateways
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/iotsitewise_gateways awscc_iotsitewise_gateways}
*/
export class DataAwsccIotsitewiseGateways extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIotsitewiseGateways that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/iotsitewise_gateways#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/data-sources/iotsitewise_gateways awscc_iotsitewise_gateways} Data Source
  *
  * @param scope The scope in which to define this construct
