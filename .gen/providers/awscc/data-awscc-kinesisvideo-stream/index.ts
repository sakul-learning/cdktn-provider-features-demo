// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/kinesisvideo_stream
...
export interface DataAwsccKinesisvideoStreamConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/kinesisvideo_stream#id DataAwsccKinesisvideoStream#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/kinesisvideo_stream awscc_kinesisvideo_stream}
*/
export class DataAwsccKinesisvideoStream extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccKinesisvideoStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/kinesisvideo_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/kinesisvideo_stream awscc_kinesisvideo_stream} Data Source
  *
  * @param scope The scope in which to define this construct
