// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job
...
export interface GlueJobConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#allocated_capacity GlueJob#allocated_capacity}
  */
  readonly allocatedCapacity?: number;
  /**
  * The code that executes a job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#command GlueJob#command}
  */
  readonly command: GlueJobCommand;
  /**
  * Specifies the connections used by a job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#connections GlueJob#connections}
  */
  readonly connections?: GlueJobConnections;
  /**
  * The default arguments for this job, specified as name-value pairs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#default_arguments GlueJob#default_arguments}
  */
  readonly defaultArguments?: string;
  /**
  * A description of the job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#description GlueJob#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the job is run with a standard or flexible execution class.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#execution_class GlueJob#execution_class}
  */
  readonly executionClass?: string;
  /**
  * The maximum number of concurrent runs that are allowed for this job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#execution_property GlueJob#execution_property}
  */
  readonly executionProperty?: GlueJobExecutionProperty;
  /**
  * Glue version determines the versions of Apache Spark and Python that AWS Glue supports.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#glue_version GlueJob#glue_version}
  */
  readonly glueVersion?: string;
  /**
  * Property description not available.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#job_mode GlueJob#job_mode}
  */
  readonly jobMode?: string;
  /**
  * Property description not available.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#job_run_queuing_enabled GlueJob#job_run_queuing_enabled}
  */
  readonly jobRunQueuingEnabled?: boolean | cdktn.IResolvable;
  /**
  * This field is reserved for future use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#log_uri GlueJob#log_uri}
  */
  readonly logUri?: string;
  /**
  * Property description not available.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#maintenance_window GlueJob#maintenance_window}
  */
  readonly maintenanceWindow?: string;
  /**
  * The number of AWS Glue data processing units (DPUs) that can be allocated when this job runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#max_capacity GlueJob#max_capacity}
  */
  readonly maxCapacity?: number;
  /**
  * The maximum number of times to retry this job after a JobRun fails
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#max_retries GlueJob#max_retries}
  */
  readonly maxRetries?: number;
  /**
  * The name you assign to the job definition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#name GlueJob#name}
  */
  readonly name?: string;
  /**
  * Non-overridable arguments for this job, specified as name-value pairs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#non_overridable_arguments GlueJob#non_overridable_arguments}
  */
  readonly nonOverridableArguments?: string;
  /**
  * Specifies configuration properties of a notification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#notification_property GlueJob#notification_property}
  */
  readonly notificationProperty?: GlueJobNotificationProperty;
  /**
  * The number of workers of a defined workerType that are allocated when a job runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#number_of_workers GlueJob#number_of_workers}
  */
  readonly numberOfWorkers?: number;
  /**
  * The name or Amazon Resource Name (ARN) of the IAM role associated with this job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#role GlueJob#role}
  */
  readonly role: string;
  /**
  * The name of the SecurityConfiguration structure to be used with this job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#security_configuration GlueJob#security_configuration}
  */
  readonly securityConfiguration?: string;
  /**
  * The tags to use with this job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#tags GlueJob#tags}
  */
  readonly tags?: string;
  /**
  * The maximum time that a job run can consume resources before it is terminated and enters TIMEOUT status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#timeout GlueJob#timeout}
  */
  readonly timeout?: number;
  /**
  * TThe type of predefined worker that is allocated when a job runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#worker_type GlueJob#worker_type}
  */
...
export interface GlueJobCommand {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#python_version GlueJob#python_version}
  */
  readonly pythonVersion?: string;
  /**
  * Runtime is used to specify the versions of Ray, Python and additional libraries available in your environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#runtime GlueJob#runtime}
  */
  readonly runtime?: string;
  /**
  * Specifies the Amazon Simple Storage Service (Amazon S3) path to a script that executes a job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#script_location GlueJob#script_location}
  */
...
export interface GlueJobExecutionProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#max_concurrent_runs GlueJob#max_concurrent_runs}
  */
...
export interface GlueJobNotificationProperty {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#notify_delay_after GlueJob#notify_delay_after}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job awscc_glue_job}
*/
export class GlueJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/resources/glue_job awscc_glue_job} Resource
  *
  * @param scope The scope in which to define this construct
