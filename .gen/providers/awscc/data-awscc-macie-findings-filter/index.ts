// https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/macie_findings_filter
...
export interface DataAwsccMacieFindingsFilterConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/macie_findings_filter#id DataAwsccMacieFindingsFilter#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/macie_findings_filter awscc_macie_findings_filter}
*/
export class DataAwsccMacieFindingsFilter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMacieFindingsFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/macie_findings_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.92.0/docs/data-sources/macie_findings_filter awscc_macie_findings_filter} Data Source
  *
  * @param scope The scope in which to define this construct
