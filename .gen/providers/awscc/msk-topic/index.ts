// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic
...
export interface MskTopicConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic#cluster_arn MskTopic#cluster_arn}
  */
  readonly clusterArn: string;
  /**
  * Base64 encoded configuration properties of the topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic#configs MskTopic#configs}
  */
  readonly configs?: string;
  /**
  * The number of partitions for the topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic#partition_count MskTopic#partition_count}
  */
  readonly partitionCount: number;
  /**
  * The replication factor for the topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic#replication_factor MskTopic#replication_factor}
  */
  readonly replicationFactor: number;
  /**
  * The name of the topic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic#topic_name MskTopic#topic_name}
  */
  readonly topicName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic awscc_msk_topic}
*/
export class MskTopic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/msk_topic awscc_msk_topic} Resource
  *
  * @param scope The scope in which to define this construct
