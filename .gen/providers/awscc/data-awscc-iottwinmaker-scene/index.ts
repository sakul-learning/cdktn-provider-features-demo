// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iottwinmaker_scene
...
export interface DataAwsccIottwinmakerSceneConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iottwinmaker_scene#id DataAwsccIottwinmakerScene#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iottwinmaker_scene awscc_iottwinmaker_scene}
*/
export class DataAwsccIottwinmakerScene extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccIottwinmakerScene that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iottwinmaker_scene#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/iottwinmaker_scene awscc_iottwinmaker_scene} Data Source
  *
  * @param scope The scope in which to define this construct
