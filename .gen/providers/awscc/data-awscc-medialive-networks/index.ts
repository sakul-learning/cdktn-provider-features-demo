// https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/medialive_networks
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/medialive_networks awscc_medialive_networks}
*/
export class DataAwsccMedialiveNetworks extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsccMedialiveNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/medialive_networks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.93.0/docs/data-sources/medialive_networks awscc_medialive_networks} Data Source
  *
  * @param scope The scope in which to define this construct
