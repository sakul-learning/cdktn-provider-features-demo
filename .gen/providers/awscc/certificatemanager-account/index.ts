// https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/certificatemanager_account
...
export interface CertificatemanagerAccountConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/certificatemanager_account#expiry_events_configuration CertificatemanagerAccount#expiry_events_configuration}
  */
...
export interface CertificatemanagerAccountExpiryEventsConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/certificatemanager_account#days_before_expiry CertificatemanagerAccount#days_before_expiry}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/certificatemanager_account awscc_certificatemanager_account}
*/
export class CertificatemanagerAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CertificatemanagerAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/certificatemanager_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.94.0/docs/resources/certificatemanager_account awscc_certificatemanager_account} Resource
  *
  * @param scope The scope in which to define this construct
