// https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_vpcdhcp_options_association
...
export interface Ec2VpcdhcpOptionsAssociationConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_vpcdhcp_options_association#dhcp_options_id Ec2VpcdhcpOptionsAssociation#dhcp_options_id}
  */
  readonly dhcpOptionsId: string;
  /**
  * The ID of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_vpcdhcp_options_association#vpc_id Ec2VpcdhcpOptionsAssociation#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_vpcdhcp_options_association awscc_ec2_vpcdhcp_options_association}
*/
export class Ec2VpcdhcpOptionsAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2VpcdhcpOptionsAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_vpcdhcp_options_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/awscc/1.91.0/docs/resources/ec2_vpcdhcp_options_association awscc_ec2_vpcdhcp_options_association} Resource
  *
  * @param scope The scope in which to define this construct
