...
export class CfncompatProviderFunctions {
  ...
  * @param content The string value to convert to Base64 (CloudFormation's `valueToEncode` parameter).
  ...
  */
  public static base64(content: string, providerLocalName?: string): string {
    return cdktn.Token.asString(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "base64", [content]));
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param ipBlock The user-specified CIDR address block (IPv4 or IPv6) to be split into smaller CIDR blocks.
  * @param count The number of CIDRs to generate. Valid range is between 1 and 256.
  * @param cidrBits The number of subnet bits for the CIDR. The resulting prefix length is `32 - cidr_bits` (IPv4) or `128 - cidr_bits` (IPv6).
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static cidr(ipBlock: string, count: number, cidrBits: number, providerLocalName?: string): string[] {
    return cdktn.Token.asList(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "cidr", [ipBlock, count, cidrBits]));
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param conditions A condition that evaluates to `true` or `false`. Minimum 2, maximum 10.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionAnd(conditions: any[], providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_and", [...conditions]);
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param listOfStrings The list of strings to search.
  * @param value The string to compare against the list of strings.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionContains(listOfStrings: any[], value: string, providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_contains", [listOfStrings, value]);
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param listOfStrings The list of strings to compare against `value`. Every member must equal `value` for the function to return `true`. An empty list returns `true`.
  * @param value The string value that every member of `list_of_strings` is compared against.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionEachMemberEquals(listOfStrings: any[], value: string, providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_each_member_equals", [listOfStrings, value]);
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param stringsToCheck A list of strings. Every member of this list is checked for membership in `strings_to_match`.
  * @param stringsToMatch A list of strings that each member of `strings_to_check` is compared against.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionEachMemberIn(stringsToCheck: any[], stringsToMatch: any[], providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_each_member_in", [stringsToCheck, stringsToMatch]);
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param value1 The first value to compare. Must be a string, number, or boolean.
  * @param value2 The second value to compare. Must be a string, number, or boolean.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionEquals(value1: any, value2: any, providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_equals", [value1, value2]);
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param condition The already-evaluated boolean value of the named condition `Fn::If` would reference in a template's `Conditions` section.
  * @param valueIfTrue The value to return if `condition` is `true`.
  * @param valueIfFalse The value to return if `condition` is `false`.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  ...
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionNot(condition: any, providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_not", [condition]);
  }
  ...
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static conditionOr(conditions: any[], providerLocalName?: string): cdktn.IResolvable {
    return cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "condition_or", [...conditions]);
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param mapping The two-level mapping to search: `top_level_key` -> `second_level_key` -> value, where each value is a string or a list of strings. Accepts either an object or a map as the underlying dynamic type, at both levels.
  * @param topLevelKey The top-level key name to look up in `mapping`.
  * @param secondLevelKey The second-level key name to look up in the entry selected by `top_level_key`.
  * @param defaultValue Optional fallback value returned if `top_level_key` or `second_level_key` is not found in `mapping` (CloudFormation's standard `Fn::FindInMap` `DefaultValue` parameter). Zero or one arguments are accepted; supplying more than one is an error. If omitted and a key is not found, this function raises an error instead.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param delimiter The value to occur between fragments. Occurs between fragments only; does not terminate the final value.
  * @param values The list of string values to combine.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static join(delimiter: string, values: any[], providerLocalName?: string): string {
    return cdktn.Token.asString(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "join", [delimiter, values]));
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param value The list, tuple, or set to count the elements of.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static lengthOf(value: any, providerLocalName?: string): number {
    return cdktn.Token.asNumber(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "length", [value]));
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param index The index of the object to retrieve, from zero to N-1 where N is the number of elements in `objects`.
  * @param objects The list (or tuple) of objects to select from. Must not be null, nor can it have null entries.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param delimiter The string value that determines where the source string is divided. Must not be empty.
  * @param source The string value to split.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static split(delimiter: string, source: string, providerLocalName?: string): string[] {
    return cdktn.Token.asList(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "split", [delimiter, source]));
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param template The string containing `${VarName}` placeholders to substitute.
  * @param variables A map of variable name to variable value used to resolve `${VarName}` placeholders in `template`.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static sub(template: string, variables: any, providerLocalName?: string): string {
    return cdktn.Token.asString(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "sub", [template, variables]));
  }
  ...
  * Note: provider-defined functions are evaluated by the provider itself — do not call this inside the configuration of the same provider (Terraform reports a self-referential cycle).
  * @param value The value (object/map, list/tuple, or primitive, arbitrarily nested) to convert to a JSON string.
  * @param providerLocalName The local name of the provider in required_providers; defaults to the registry short name. Override when the provider is declared under a different local name — aliases do not change the namespace, local names do.
  */
  public static toJsonString(value: any, providerLocalName?: string): string {
    return cdktn.Token.asString(cdktn.TerraformProviderFunction.invoke(providerLocalName ?? "cfncompat", "to_json_string", [value]));
  }
}
