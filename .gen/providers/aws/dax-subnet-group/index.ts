// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dax_subnet_group
...
export class DaxSubnetGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DaxSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dax_subnet_group#import import section} in the documentation of this resource for the id to use
