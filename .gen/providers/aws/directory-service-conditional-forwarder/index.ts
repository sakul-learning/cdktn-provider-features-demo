// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/directory_service_conditional_forwarder
...
export class DirectoryServiceConditionalForwarder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceConditionalForwarder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/directory_service_conditional_forwarder#import import section} in the documentation of this resource for the id to use
