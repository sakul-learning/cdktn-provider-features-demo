// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/dx_router_configuration
...
export class DataAwsDxRouterConfigurationRouterOutputReference extends cdktn.ComplexObject {
...
export class DataAwsDxRouterConfigurationRouterList extends cdktn.ComplexList {
...
export class DataAwsDxRouterConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDxRouterConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/dx_router_configuration#import import section} in the documentation of this resource for the id to use
