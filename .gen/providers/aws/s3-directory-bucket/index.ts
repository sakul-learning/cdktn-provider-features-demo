// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/s3_directory_bucket
...
export class S3DirectoryBucket extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3DirectoryBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/s3_directory_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/s3_directory_bucket aws_s3_directory_bucket} Resource
  *
  * @param scope The scope in which to define this construct
