// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/finspace_kx_volume
...
export class FinspaceKxVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FinspaceKxVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/finspace_kx_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/finspace_kx_volume aws_finspace_kx_volume} Resource
  *
  * @param scope The scope in which to define this construct
