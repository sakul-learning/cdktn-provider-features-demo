// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dynamodb_table
...
export class DynamodbTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dynamodb_table#import import section} in the documentation of this resource for the id to use
