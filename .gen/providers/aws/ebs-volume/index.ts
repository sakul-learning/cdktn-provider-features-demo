// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ebs_volume
...
export class EbsVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ebs_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ebs_volume aws_ebs_volume} Resource
  *
  * @param scope The scope in which to define this construct
