// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rekognition_stream_processor
...
export interface RekognitionStreamProcessorConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rekognition_stream_processor#tags RekognitionStreamProcessor#tags}
  */
...
export class RekognitionStreamProcessorRegionsOfInterestBoundingBoxList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): RekognitionStreamProcessorRegionsOfInterestBoundingBoxOutputReference {
    return new RekognitionStreamProcessorRegionsOfInterestBoundingBoxOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class RekognitionStreamProcessorRegionsOfInterestOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _boundingBox = new RekognitionStreamProcessorRegionsOfInterestBoundingBoxList(this, "bounding_box", false);
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rekognition_stream_processor aws_rekognition_stream_processor}
*/
export class RekognitionStreamProcessor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RekognitionStreamProcessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rekognition_stream_processor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rekognition_stream_processor aws_rekognition_stream_processor} Resource
  *
  * @param scope The scope in which to define this construct
