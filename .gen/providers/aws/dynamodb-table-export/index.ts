// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dynamodb_table_export
...
export class DynamodbTableExport extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbTableExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dynamodb_table_export#import import section} in the documentation of this resource for the id to use
