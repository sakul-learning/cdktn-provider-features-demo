// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/alb
...
export class Alb extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Alb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/alb#import import section} in the documentation of this resource for the id to use
