// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/alb
...
export class AlbHealthCheckLogsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AlbHealthCheckLogs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._bucket !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: AlbHealthCheckLogs | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._bucket = undefined;
      this._enabled = undefined;
...
export class Alb extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Alb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/alb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _healthCheckLogs = new AlbHealthCheckLogsOutputReference(this, "health_check_logs");
  public get healthCheckLogs() {
    return this._healthCheckLogs;
  }
  public putHealthCheckLogs(value: AlbHealthCheckLogs) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      health_check_logs: {
        value: albHealthCheckLogsToHclTerraform(this._healthCheckLogs.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AlbHealthCheckLogsList",
      },
      ipam_pools: {
