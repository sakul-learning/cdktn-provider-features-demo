// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/appconfig_deployment_strategy
...
export class AppconfigDeploymentStrategy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigDeploymentStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/appconfig_deployment_strategy#import import section} in the documentation of this resource for the id to use
