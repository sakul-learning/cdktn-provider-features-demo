// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/paymentcryptography_key
...
export class PaymentcryptographyKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PaymentcryptographyKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/paymentcryptography_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/paymentcryptography_key aws_paymentcryptography_key} Resource
  *
  * @param scope The scope in which to define this construct
