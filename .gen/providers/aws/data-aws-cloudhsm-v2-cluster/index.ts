// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/cloudhsm_v2_cluster
...
export class DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference extends cdktn.ComplexObject {
...
export class DataAwsCloudhsmV2ClusterClusterCertificatesList extends cdktn.ComplexList {
...
export class DataAwsCloudhsmV2Cluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudhsmV2Cluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/cloudhsm_v2_cluster#import import section} in the documentation of this resource for the id to use
