// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ami_from_instance
...
export class AmiFromInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AmiFromInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ami_from_instance#import import section} in the documentation of this resource for the id to use
