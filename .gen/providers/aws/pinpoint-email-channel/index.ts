// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpoint_email_channel
...
export class PinpointEmailChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointEmailChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpoint_email_channel#import import section} in the documentation of this resource for the id to use
