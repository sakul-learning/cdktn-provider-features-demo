// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/fsx_openzfs_volume
...
export class FsxOpenzfsVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxOpenzfsVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/fsx_openzfs_volume#import import section} in the documentation of this resource for the id to use
