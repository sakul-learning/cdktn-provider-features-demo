// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster
...
export class DocdbGlobalClusterGlobalClusterMembersOutputReference extends cdktn.ComplexObject {
...
export class DocdbGlobalClusterGlobalClusterMembersList extends cdktn.ComplexList {
...
export interface DocdbGlobalClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster#create DocdbGlobalCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster#delete DocdbGlobalCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster#update DocdbGlobalCluster#update}
  */
  readonly update?: string;
}

export function docdbGlobalClusterTimeoutsToTerraform(struct?: DocdbGlobalClusterTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function docdbGlobalClusterTimeoutsToHclTerraform(struct?: DocdbGlobalClusterTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DocdbGlobalClusterTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DocdbGlobalClusterTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DocdbGlobalClusterTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster aws_docdb_global_cluster}
*/
export class DocdbGlobalCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbGlobalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/docdb_global_cluster aws_docdb_global_cluster} Resource
  *
  * @param scope The scope in which to define this construct
