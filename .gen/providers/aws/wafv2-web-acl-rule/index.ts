...
Wafv2WebAclRuleVisibilityConfigAList} from './index-structs/index';
...
export class Wafv2WebAclRuleA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2WebAclRuleA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/wafv2_web_acl_rule#import import section} in the documentation of this resource for the id to use
