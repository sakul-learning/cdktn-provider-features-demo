// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/bedrock_use_case_for_model_access
...
export class BedrockUseCaseForModelAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockUseCaseForModelAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/bedrock_use_case_for_model_access#import import section} in the documentation of this resource for the id to use
