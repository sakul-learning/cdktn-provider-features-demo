// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iot_topic_rule_destination
...
export class IotTopicRuleDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotTopicRuleDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iot_topic_rule_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iot_topic_rule_destination aws_iot_topic_rule_destination} Resource
  *
  * @param scope The scope in which to define this construct
