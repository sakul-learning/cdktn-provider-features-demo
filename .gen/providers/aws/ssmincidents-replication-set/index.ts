// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ssmincidents_replication_set
...
export class SsmincidentsReplicationSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmincidentsReplicationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/ssmincidents_replication_set#import import section} in the documentation of this resource for the id to use
