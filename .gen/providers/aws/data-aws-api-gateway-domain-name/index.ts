// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/api_gateway_domain_name
...
export class DataAwsApiGatewayDomainName extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/api_gateway_domain_name#import import section} in the documentation of this resource for the id to use
