// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/vpc_endpoint_service_allowed_principal
...
export class VpcEndpointServiceAllowedPrincipal extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointServiceAllowedPrincipal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/vpc_endpoint_service_allowed_principal#import import section} in the documentation of this resource for the id to use
