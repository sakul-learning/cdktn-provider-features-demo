// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/uxc_account_customizations
...
export class UxcAccountCustomizations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing UxcAccountCustomizations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/uxc_account_customizations#import import section} in the documentation of this resource for the id to use
  ...
  * @param options UxcAccountCustomizationsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: UxcAccountCustomizationsConfig = {}) {
    super(scope, id, {
