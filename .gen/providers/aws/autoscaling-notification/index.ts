// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/autoscaling_notification
...
export class AutoscalingNotification extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AutoscalingNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/autoscaling_notification#import import section} in the documentation of this resource for the id to use
