// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/bedrock_foundation_model_agreement
...
export class BedrockFoundationModelAgreement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockFoundationModelAgreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/bedrock_foundation_model_agreement#import import section} in the documentation of this resource for the id to use
