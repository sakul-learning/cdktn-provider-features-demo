// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/s3_bucket_notification
...
export class S3BucketNotification extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/s3_bucket_notification#import import section} in the documentation of this resource for the id to use
