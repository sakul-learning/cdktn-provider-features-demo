// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpc_ipam
...
export class DataAwsVpcIpamOperatingRegionsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsVpcIpamOperatingRegionsList extends cdktn.ComplexList {
...
export class DataAwsVpcIpam extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpam that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpc_ipam#import import section} in the documentation of this resource for the id to use
