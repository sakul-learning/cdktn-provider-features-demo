// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ebs_snapshot_copy
...
export class EbsSnapshotCopy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsSnapshotCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ebs_snapshot_copy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ebs_snapshot_copy aws_ebs_snapshot_copy} Resource
  *
  * @param scope The scope in which to define this construct
