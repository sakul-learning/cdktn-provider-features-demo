// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/identitystore_groups
...
export class DataAwsIdentitystoreGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIdentitystoreGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/identitystore_groups#import import section} in the documentation of this resource for the id to use
