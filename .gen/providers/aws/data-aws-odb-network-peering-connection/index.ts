// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/odb_network_peering_connection
...
export class DataAwsOdbNetworkPeeringConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbNetworkPeeringConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/odb_network_peering_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/odb_network_peering_connection aws_odb_network_peering_connection} Data Source
  *
  * @param scope The scope in which to define this construct
