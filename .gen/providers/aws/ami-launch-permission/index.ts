// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ami_launch_permission
...
export class AmiLaunchPermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AmiLaunchPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ami_launch_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ami_launch_permission aws_ami_launch_permission} Resource
  *
  * @param scope The scope in which to define this construct
