// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/backup_report_plan
...
export class DataAwsBackupReportPlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBackupReportPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/backup_report_plan#import import section} in the documentation of this resource for the id to use
