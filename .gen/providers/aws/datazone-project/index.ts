// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datazone_project
...
export class DatazoneProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datazone_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datazone_project aws_datazone_project} Resource
  *
  * @param scope The scope in which to define this construct
