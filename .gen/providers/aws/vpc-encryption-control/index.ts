// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc_encryption_control
...
export class VpcEncryptionControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEncryptionControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc_encryption_control#import import section} in the documentation of this resource for the id to use
