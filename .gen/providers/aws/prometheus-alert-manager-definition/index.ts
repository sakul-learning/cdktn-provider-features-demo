// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/prometheus_alert_manager_definition
...
export class PrometheusAlertManagerDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusAlertManagerDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/prometheus_alert_manager_definition#import import section} in the documentation of this resource for the id to use
