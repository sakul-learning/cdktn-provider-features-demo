// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/auditmanager_framework_share
...
export class AuditmanagerFrameworkShare extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditmanagerFrameworkShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/auditmanager_framework_share#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/auditmanager_framework_share aws_auditmanager_framework_share} Resource
  *
  * @param scope The scope in which to define this construct
