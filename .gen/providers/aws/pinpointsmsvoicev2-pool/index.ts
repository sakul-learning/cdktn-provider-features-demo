// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpointsmsvoicev2_pool
...
export class Pinpointsmsvoicev2Pool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Pinpointsmsvoicev2Pool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpointsmsvoicev2_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpointsmsvoicev2_pool aws_pinpointsmsvoicev2_pool} Resource
  *
  * @param scope The scope in which to define this construct
