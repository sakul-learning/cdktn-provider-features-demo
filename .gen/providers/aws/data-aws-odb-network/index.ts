// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/odb_network
...
export class DataAwsOdbNetwork extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/odb_network#import import section} in the documentation of this resource for the id to use
