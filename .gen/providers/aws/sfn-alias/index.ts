// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/sfn_alias
...
export class SfnAlias extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SfnAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/sfn_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/sfn_alias aws_sfn_alias} Resource
  *
  * @param scope The scope in which to define this construct
