// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/grafana_workspace_service_account
...
export class GrafanaWorkspaceServiceAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaWorkspaceServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/grafana_workspace_service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/grafana_workspace_service_account aws_grafana_workspace_service_account} Resource
  *
  * @param scope The scope in which to define this construct
