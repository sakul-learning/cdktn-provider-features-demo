// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/sesv2_email_identity_mail_from_attributes
...
export class Sesv2EmailIdentityMailFromAttributes extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2EmailIdentityMailFromAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/sesv2_email_identity_mail_from_attributes#import import section} in the documentation of this resource for the id to use
