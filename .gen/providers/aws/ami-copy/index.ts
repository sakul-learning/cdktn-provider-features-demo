// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ami_copy
...
export class AmiCopy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AmiCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ami_copy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ami_copy aws_ami_copy} Resource
  *
  * @param scope The scope in which to define this construct
