// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/workmail_default_domain
...
export class WorkmailDefaultDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkmailDefaultDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/workmail_default_domain#import import section} in the documentation of this resource for the id to use
