// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/mq_broker_engine_types
...
export class DataAwsMqBrokerEngineTypesBrokerEngineTypesEngineVersionsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsMqBrokerEngineTypesBrokerEngineTypesEngineVersionsList extends cdktn.ComplexList {
...
export class DataAwsMqBrokerEngineTypesBrokerEngineTypesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsMqBrokerEngineTypesBrokerEngineTypesList extends cdktn.ComplexList {
...
export class DataAwsMqBrokerEngineTypes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMqBrokerEngineTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/mq_broker_engine_types#import import section} in the documentation of this resource for the id to use
