// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/kms_key_policy
...
export class KmsKeyPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsKeyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/kms_key_policy#import import section} in the documentation of this resource for the id to use
