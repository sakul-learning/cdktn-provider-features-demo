// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/s3control_access_points
...
export class DataAwsS3ControlAccessPoints extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsS3ControlAccessPoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/s3control_access_points#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/s3control_access_points aws_s3control_access_points} Data Source
  *
  * @param scope The scope in which to define this construct
