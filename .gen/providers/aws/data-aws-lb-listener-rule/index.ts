// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/lb_listener_rule
...
export class DataAwsLbListenerRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLbListenerRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/lb_listener_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/lb_listener_rule aws_lb_listener_rule} Data Source
  *
  * @param scope The scope in which to define this construct
