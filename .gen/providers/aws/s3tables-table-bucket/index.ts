// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/s3tables_table_bucket
...
export class S3TablesTableBucket extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3TablesTableBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/s3tables_table_bucket#import import section} in the documentation of this resource for the id to use
