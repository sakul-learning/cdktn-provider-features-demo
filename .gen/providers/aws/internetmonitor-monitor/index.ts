// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/internetmonitor_monitor
...
export class InternetmonitorMonitor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InternetmonitorMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/internetmonitor_monitor#import import section} in the documentation of this resource for the id to use
