// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lakeformation_resource_lf_tags
...
export class LakeformationResourceLfTags extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LakeformationResourceLfTags that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lakeformation_resource_lf_tags#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lakeformation_resource_lf_tags aws_lakeformation_resource_lf_tags} Resource
  *
  * @param scope The scope in which to define this construct
