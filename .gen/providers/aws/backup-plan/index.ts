// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/backup_plan
...
export class BackupPlan extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/backup_plan#import import section} in the documentation of this resource for the id to use
