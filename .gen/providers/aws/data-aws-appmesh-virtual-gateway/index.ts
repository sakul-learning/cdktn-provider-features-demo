// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/appmesh_virtual_gateway
...
export class DataAwsAppmeshVirtualGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppmeshVirtualGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/appmesh_virtual_gateway#import import section} in the documentation of this resource for the id to use
