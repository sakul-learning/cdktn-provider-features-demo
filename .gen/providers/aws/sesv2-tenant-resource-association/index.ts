// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/sesv2_tenant_resource_association
...
export class Sesv2TenantResourceAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2TenantResourceAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/sesv2_tenant_resource_association#import import section} in the documentation of this resource for the id to use
