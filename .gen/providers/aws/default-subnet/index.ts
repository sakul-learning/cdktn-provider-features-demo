// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/default_subnet
...
export class DefaultSubnet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/default_subnet#import import section} in the documentation of this resource for the id to use
