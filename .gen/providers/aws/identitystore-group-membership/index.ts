// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/identitystore_group_membership
...
export class IdentitystoreGroupMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentitystoreGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/identitystore_group_membership#import import section} in the documentation of this resource for the id to use
