// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/qldb_ledger
...
export class QldbLedger extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QldbLedger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/qldb_ledger#import import section} in the documentation of this resource for the id to use
