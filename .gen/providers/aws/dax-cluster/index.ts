// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dax_cluster
...
export interface DaxClusterConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DaxClusterNodesOutputReference extends cdktn.ComplexObject {
...
export class DaxClusterNodesList extends cdktn.ComplexList {
...
export class DaxClusterServerSideEncryptionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function daxClusterTimeoutsToTerraform(struct?: DaxClusterTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function daxClusterTimeoutsToHclTerraform(struct?: DaxClusterTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DaxClusterTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DaxClusterTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DaxClusterTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DaxCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DaxCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dax_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dax_cluster aws_dax_cluster} Resource
  *
  * @param scope The scope in which to define this construct
