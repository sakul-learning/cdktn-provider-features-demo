// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dax_cluster
...
export class DaxCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DaxCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dax_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dax_cluster aws_dax_cluster} Resource
  *
  * @param scope The scope in which to define this construct
