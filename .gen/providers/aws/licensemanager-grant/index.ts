// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/licensemanager_grant
...
export class LicensemanagerGrant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LicensemanagerGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/licensemanager_grant#import import section} in the documentation of this resource for the id to use
