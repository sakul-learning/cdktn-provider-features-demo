// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/datazone_user_profile
...
export class DatazoneUserProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneUserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/datazone_user_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/datazone_user_profile aws_datazone_user_profile} Resource
  *
  * @param scope The scope in which to define this construct
