// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc_ipam_pool_cidr_allocation
...
export class VpcIpamPoolCidrAllocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamPoolCidrAllocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc_ipam_pool_cidr_allocation#import import section} in the documentation of this resource for the id to use
