// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/kendra_faq
...
export class DataAwsKendraFaqS3PathOutputReference extends cdktn.ComplexObject {
...
export class DataAwsKendraFaqS3PathList extends cdktn.ComplexList {
...
export class DataAwsKendraFaq extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKendraFaq that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/kendra_faq#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/kendra_faq aws_kendra_faq} Data Source
  *
  * @param scope The scope in which to define this construct
