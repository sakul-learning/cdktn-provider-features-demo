// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/verifiedpermissions_policy
...
export class VerifiedpermissionsPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedpermissionsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/verifiedpermissions_policy#import import section} in the documentation of this resource for the id to use
