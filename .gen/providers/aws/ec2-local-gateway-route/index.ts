// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_local_gateway_route
...
export class Ec2LocalGatewayRoute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2LocalGatewayRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_local_gateway_route#import import section} in the documentation of this resource for the id to use
