// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/networkfirewall_firewall
...
export class DataAwsNetworkfirewallFirewall extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkfirewallFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/networkfirewall_firewall#import import section} in the documentation of this resource for the id to use
