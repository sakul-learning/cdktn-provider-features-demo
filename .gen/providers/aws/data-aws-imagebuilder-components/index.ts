// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/imagebuilder_components
...
export class DataAwsImagebuilderComponents extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsImagebuilderComponents that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/imagebuilder_components#import import section} in the documentation of this resource for the id to use
