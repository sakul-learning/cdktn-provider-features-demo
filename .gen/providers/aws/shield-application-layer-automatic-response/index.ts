// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/shield_application_layer_automatic_response
...
export class ShieldApplicationLayerAutomaticResponse extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldApplicationLayerAutomaticResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/shield_application_layer_automatic_response#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ShieldApplicationLayerAutomaticResponseConfig) {
    super(scope, id, {
  ...
  private _timeouts = new ShieldApplicationLayerAutomaticResponseTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ShieldApplicationLayerAutomaticResponseTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: shieldApplicationLayerAutomaticResponseTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ShieldApplicationLayerAutomaticResponseTimeouts",
      },
    };
