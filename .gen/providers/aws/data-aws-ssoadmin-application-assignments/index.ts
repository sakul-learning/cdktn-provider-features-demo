// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ssoadmin_application_assignments
...
export class DataAwsSsoadminApplicationAssignmentsApplicationAssignmentsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsSsoadminApplicationAssignmentsApplicationAssignmentsList extends cdktn.ComplexList {
...
export class DataAwsSsoadminApplicationAssignments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsoadminApplicationAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ssoadmin_application_assignments#import import section} in the documentation of this resource for the id to use
