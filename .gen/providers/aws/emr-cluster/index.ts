// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/emr_cluster
...
export class EmrCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/emr_cluster#import import section} in the documentation of this resource for the id to use
