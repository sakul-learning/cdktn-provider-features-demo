// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/default_vpc
...
export class DefaultVpc extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/default_vpc#import import section} in the documentation of this resource for the id to use
