// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/devopsguru_event_sources_config
...
export class DevopsguruEventSourcesConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DevopsguruEventSourcesConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/devopsguru_event_sources_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/devopsguru_event_sources_config aws_devopsguru_event_sources_config} Resource
  *
  * @param scope The scope in which to define this construct
