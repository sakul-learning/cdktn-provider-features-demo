// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/networkmanager_core_network_policy_attachment
...
export class NetworkmanagerCoreNetworkPolicyAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerCoreNetworkPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/networkmanager_core_network_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/networkmanager_core_network_policy_attachment aws_networkmanager_core_network_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
