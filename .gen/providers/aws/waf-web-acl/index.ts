// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/waf_web_acl
...
export class WafWebAcl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafWebAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/waf_web_acl#import import section} in the documentation of this resource for the id to use
