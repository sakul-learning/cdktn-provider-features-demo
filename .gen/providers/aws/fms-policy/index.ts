// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/fms_policy
...
export class FmsPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FmsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/fms_policy#import import section} in the documentation of this resource for the id to use
