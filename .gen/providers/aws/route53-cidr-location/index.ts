// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/route53_cidr_location
...
export class Route53CidrLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53CidrLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/route53_cidr_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/route53_cidr_location aws_route53_cidr_location} Resource
  *
  * @param scope The scope in which to define this construct
