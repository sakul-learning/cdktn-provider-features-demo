// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/lex_bot
...
export class LexBot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LexBot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/lex_bot#import import section} in the documentation of this resource for the id to use
