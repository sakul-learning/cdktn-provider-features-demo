// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/db_proxy_target
...
export interface DbProxyTargetConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DbProxyTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbProxyTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/db_proxy_target#import import section} in the documentation of this resource for the id to use
