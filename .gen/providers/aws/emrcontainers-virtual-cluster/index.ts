// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/emrcontainers_virtual_cluster
...
export interface EmrcontainersVirtualClusterConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class EmrcontainersVirtualClusterContainerProviderInfoEksInfoOutputReference extends cdktn.ComplexObject {
...
export class EmrcontainersVirtualClusterContainerProviderInfoOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class EmrcontainersVirtualClusterContainerProviderOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function emrcontainersVirtualClusterTimeoutsToTerraform(struct?: EmrcontainersVirtualClusterTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function emrcontainersVirtualClusterTimeoutsToHclTerraform(struct?: EmrcontainersVirtualClusterTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class EmrcontainersVirtualClusterTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): EmrcontainersVirtualClusterTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: EmrcontainersVirtualClusterTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class EmrcontainersVirtualCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrcontainersVirtualCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/emrcontainers_virtual_cluster#import import section} in the documentation of this resource for the id to use
