// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/emrcontainers_virtual_cluster
...
export class EmrcontainersVirtualCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrcontainersVirtualCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/emrcontainers_virtual_cluster#import import section} in the documentation of this resource for the id to use
