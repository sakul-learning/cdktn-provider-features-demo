// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/keyspaces_keyspace
...
export class KeyspacesKeyspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyspacesKeyspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/keyspaces_keyspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/keyspaces_keyspace aws_keyspaces_keyspace} Resource
  *
  * @param scope The scope in which to define this construct
