// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/applicationinsights_application
...
export class ApplicationinsightsApplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationinsightsApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/applicationinsights_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/applicationinsights_application aws_applicationinsights_application} Resource
  *
  * @param scope The scope in which to define this construct
