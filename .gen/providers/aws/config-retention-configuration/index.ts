// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/config_retention_configuration
...
export class ConfigRetentionConfiguration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigRetentionConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/config_retention_configuration#import import section} in the documentation of this resource for the id to use
