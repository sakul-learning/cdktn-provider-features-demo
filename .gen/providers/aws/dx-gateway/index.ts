// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/dx_gateway
...
export class DxGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DxGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/dx_gateway#import import section} in the documentation of this resource for the id to use
