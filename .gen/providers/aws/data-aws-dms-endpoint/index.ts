// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/dms_endpoint
...
export class DataAwsDmsEndpoint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDmsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/dms_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/dms_endpoint aws_dms_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
