// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/elasticache_cluster
...
export class DataAwsElasticacheClusterCacheNodesOutputReference extends cdktn.ComplexObject {
...
export class DataAwsElasticacheClusterCacheNodesList extends cdktn.ComplexList {
...
export class DataAwsElasticacheClusterLogDeliveryConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsElasticacheClusterLogDeliveryConfigurationList extends cdktn.ComplexList {
...
export class DataAwsElasticacheCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticacheCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/elasticache_cluster#import import section} in the documentation of this resource for the id to use
