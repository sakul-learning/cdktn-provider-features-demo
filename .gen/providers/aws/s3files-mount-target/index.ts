// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/s3files_mount_target
...
export interface S3FilesMountTargetConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly timeouts?: S3FilesMountTargetTimeouts;
}
export interface S3FilesMountTargetTimeouts {
  /**
...
export function s3FilesMountTargetTimeoutsToTerraform(struct?: S3FilesMountTargetTimeouts | cdktn.IResolvable): any {
...
export function s3FilesMountTargetTimeoutsToHclTerraform(struct?: S3FilesMountTargetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class S3FilesMountTargetTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): S3FilesMountTargetTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: S3FilesMountTargetTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class S3FilesMountTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3FilesMountTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/s3files_mount_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/s3files_mount_target aws_s3files_mount_target} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _timeouts = new S3FilesMountTargetTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: S3FilesMountTargetTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: s3FilesMountTargetTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: s3FilesMountTargetTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "S3FilesMountTargetTimeouts",
      },
    };
