// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/devopsguru_resource_collection
...
export interface DevopsguruResourceCollectionCloudformation {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/devopsguru_resource_collection#stack_names DevopsguruResourceCollection#stack_names}
  */
...
export class DevopsguruResourceCollection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DevopsguruResourceCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/devopsguru_resource_collection#import import section} in the documentation of this resource for the id to use
