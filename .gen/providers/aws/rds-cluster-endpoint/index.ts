// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rds_cluster_endpoint
...
export class RdsClusterEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsClusterEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rds_cluster_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/rds_cluster_endpoint aws_rds_cluster_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
