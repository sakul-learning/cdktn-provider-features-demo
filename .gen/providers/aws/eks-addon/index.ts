// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eks_addon
...
export class EksAddon extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksAddon that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eks_addon#import import section} in the documentation of this resource for the id to use
