// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/appconfig_deployment
...
export class AppconfigDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/appconfig_deployment#import import section} in the documentation of this resource for the id to use
