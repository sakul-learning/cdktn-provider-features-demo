// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/appconfig_extension
...
export class AppconfigExtension extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigExtension that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/appconfig_extension#import import section} in the documentation of this resource for the id to use
