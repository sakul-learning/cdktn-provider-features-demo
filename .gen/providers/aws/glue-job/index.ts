// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/glue_job
...
export class GlueJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/glue_job#import import section} in the documentation of this resource for the id to use
