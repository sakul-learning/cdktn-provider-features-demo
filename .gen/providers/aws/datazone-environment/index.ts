// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/datazone_environment
...
export class DatazoneEnvironment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/datazone_environment#import import section} in the documentation of this resource for the id to use
