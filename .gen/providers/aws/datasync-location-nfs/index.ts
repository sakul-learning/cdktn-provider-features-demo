// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datasync_location_nfs
...
export class DatasyncLocationNfs extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationNfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datasync_location_nfs#import import section} in the documentation of this resource for the id to use
