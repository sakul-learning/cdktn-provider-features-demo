// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/msk_topic
...
export class DataAwsMskTopic extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMskTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/msk_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/msk_topic aws_msk_topic} Data Source
  *
  * @param scope The scope in which to define this construct
