// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/prometheus_workspace
...
export interface PrometheusWorkspaceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class PrometheusWorkspaceLoggingConfigurationOutputReference extends cdktn.ComplexObject {
...
*/
export class PrometheusWorkspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/prometheus_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/prometheus_workspace aws_prometheus_workspace} Resource
  *
  * @param scope The scope in which to define this construct
