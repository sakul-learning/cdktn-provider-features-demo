// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/alb_listener
...
export class AlbListener extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AlbListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/alb_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/alb_listener aws_alb_listener} Resource
  *
  * @param scope The scope in which to define this construct
