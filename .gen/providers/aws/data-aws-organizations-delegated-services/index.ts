// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/organizations_delegated_services
...
export class DataAwsOrganizationsDelegatedServicesDelegatedServicesOutputReference extends cdktn.ComplexObject {
...
export class DataAwsOrganizationsDelegatedServicesDelegatedServicesList extends cdktn.ComplexList {
...
export class DataAwsOrganizationsDelegatedServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsDelegatedServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/organizations_delegated_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/organizations_delegated_services aws_organizations_delegated_services} Data Source
  *
  * @param scope The scope in which to define this construct
