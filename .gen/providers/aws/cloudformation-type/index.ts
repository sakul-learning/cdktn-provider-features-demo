// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/cloudformation_type
...
export class CloudformationType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudformationType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/cloudformation_type#import import section} in the documentation of this resource for the id to use
