// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/elasticache_global_replication_group
...
export class ElasticacheGlobalReplicationGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheGlobalReplicationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/elasticache_global_replication_group#import import section} in the documentation of this resource for the id to use
