// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lb_trust_store_revocation
...
export class LbTrustStoreRevocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LbTrustStoreRevocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lb_trust_store_revocation#import import section} in the documentation of this resource for the id to use
