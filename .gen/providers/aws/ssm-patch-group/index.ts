// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ssm_patch_group
...
export class SsmPatchGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmPatchGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ssm_patch_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ssm_patch_group aws_ssm_patch_group} Resource
  *
  * @param scope The scope in which to define this construct
