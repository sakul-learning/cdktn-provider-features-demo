// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/cognito_user_pool_ui_customization
...
export class CognitoUserPoolUiCustomization extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoUserPoolUiCustomization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/cognito_user_pool_ui_customization#import import section} in the documentation of this resource for the id to use
