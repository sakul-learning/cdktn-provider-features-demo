// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/eks_fargate_profile
...
export class EksFargateProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksFargateProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/eks_fargate_profile#import import section} in the documentation of this resource for the id to use
