// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/media_package_channel
...
export class MediaPackageChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaPackageChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/media_package_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/media_package_channel aws_media_package_channel} Resource
  *
  * @param scope The scope in which to define this construct
