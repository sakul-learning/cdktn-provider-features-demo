// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/msk_topic
...
export class MskTopic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/msk_topic#import import section} in the documentation of this resource for the id to use
