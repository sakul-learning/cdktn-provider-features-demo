// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ec2_capacity_block_reservation
...
export class Ec2CapacityBlockReservation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2CapacityBlockReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ec2_capacity_block_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ec2_capacity_block_reservation aws_ec2_capacity_block_reservation} Resource
  *
  * @param scope The scope in which to define this construct
