// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpoint_app
...
export class PinpointApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/pinpoint_app#import import section} in the documentation of this resource for the id to use
