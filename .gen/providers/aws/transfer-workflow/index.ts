// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/transfer_workflow
...
export class TransferWorkflow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/transfer_workflow#import import section} in the documentation of this resource for the id to use
