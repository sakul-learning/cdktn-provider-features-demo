// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/networkmanager_device
...
export class DataAwsNetworkmanagerDevice extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/networkmanager_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/networkmanager_device aws_networkmanager_device} Data Source
  *
  * @param scope The scope in which to define this construct
