// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dynamodb_kinesis_streaming_destination
...
export class DynamodbKinesisStreamingDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbKinesisStreamingDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dynamodb_kinesis_streaming_destination#import import section} in the documentation of this resource for the id to use
