// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/devopsguru_service_integration
...
export class DevopsguruServiceIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DevopsguruServiceIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/devopsguru_service_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/devopsguru_service_integration aws_devopsguru_service_integration} Resource
  *
  * @param scope The scope in which to define this construct
