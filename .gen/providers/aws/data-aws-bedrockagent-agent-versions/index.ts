// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/bedrockagent_agent_versions
...
export class DataAwsBedrockagentAgentVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBedrockagentAgentVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/bedrockagent_agent_versions#import import section} in the documentation of this resource for the id to use
