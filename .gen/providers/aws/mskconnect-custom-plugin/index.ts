// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin
...
export interface MskconnectCustomPluginConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#content_type MskconnectCustomPlugin#content_type}
  */
  readonly contentType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#description MskconnectCustomPlugin#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#id MskconnectCustomPlugin#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#name MskconnectCustomPlugin#name}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#tags MskconnectCustomPlugin#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#tags_all MskconnectCustomPlugin#tags_all}
  */
...
export class MskconnectCustomPluginLocationS3OutputReference extends cdktn.ComplexObject {
...
export class MskconnectCustomPluginLocationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface MskconnectCustomPluginTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#create MskconnectCustomPlugin#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#delete MskconnectCustomPlugin#delete}
  */
  readonly delete?: string;
}

export function mskconnectCustomPluginTimeoutsToTerraform(struct?: MskconnectCustomPluginTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function mskconnectCustomPluginTimeoutsToHclTerraform(struct?: MskconnectCustomPluginTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class MskconnectCustomPluginTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): MskconnectCustomPluginTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: MskconnectCustomPluginTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class MskconnectCustomPlugin extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskconnectCustomPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/mskconnect_custom_plugin#import import section} in the documentation of this resource for the id to use
