// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/macie2_custom_data_identifier
...
export class Macie2CustomDataIdentifier extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Macie2CustomDataIdentifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/macie2_custom_data_identifier#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/macie2_custom_data_identifier aws_macie2_custom_data_identifier} Resource
  *
  * @param scope The scope in which to define this construct
