// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/licensemanager_grant_accepter
...
export class LicensemanagerGrantAccepter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LicensemanagerGrantAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/licensemanager_grant_accepter#import import section} in the documentation of this resource for the id to use
