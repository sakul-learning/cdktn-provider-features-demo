// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/grafana_workspace
...
export class GrafanaWorkspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/grafana_workspace#import import section} in the documentation of this resource for the id to use
