// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/workspacesweb_session_logger_association
...
export class WorkspaceswebSessionLoggerAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceswebSessionLoggerAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/workspacesweb_session_logger_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/workspacesweb_session_logger_association aws_workspacesweb_session_logger_association} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WorkspaceswebSessionLoggerAssociationConfig
  */
  public constructor(scope: Construct, id: string, config: WorkspaceswebSessionLoggerAssociationConfig) {
    super(scope, id, {
