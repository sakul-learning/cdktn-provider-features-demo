// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/batch_compute_environment
...
export class DataAwsBatchComputeEnvironment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBatchComputeEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/batch_compute_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/batch_compute_environment aws_batch_compute_environment} Data Source
  *
  * @param scope The scope in which to define this construct
