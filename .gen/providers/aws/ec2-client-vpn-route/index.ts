// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ec2_client_vpn_route
...
export class Ec2ClientVpnRoute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ClientVpnRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ec2_client_vpn_route#import import section} in the documentation of this resource for the id to use
