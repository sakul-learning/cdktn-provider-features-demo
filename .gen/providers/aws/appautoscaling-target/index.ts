// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/appautoscaling_target
...
export class AppautoscalingTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppautoscalingTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/appautoscaling_target#import import section} in the documentation of this resource for the id to use
