// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/servicequotas_auto_management
...
export class ServicequotasAutoManagement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicequotasAutoManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/servicequotas_auto_management#import import section} in the documentation of this resource for the id to use
