// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/elastic_beanstalk_application
...
export class DataAwsElasticBeanstalkApplicationAppversionLifecycleOutputReference extends cdktn.ComplexObject {
...
export class DataAwsElasticBeanstalkApplicationAppversionLifecycleList extends cdktn.ComplexList {
...
export class DataAwsElasticBeanstalkApplication extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticBeanstalkApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/elastic_beanstalk_application#import import section} in the documentation of this resource for the id to use
