// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/db_option_group
...
export class DbOptionGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbOptionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/db_option_group#import import section} in the documentation of this resource for the id to use
