// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/service_discovery_service
...
export class ServiceDiscoveryService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDiscoveryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/service_discovery_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/service_discovery_service aws_service_discovery_service} Resource
  *
  * @param scope The scope in which to define this construct
