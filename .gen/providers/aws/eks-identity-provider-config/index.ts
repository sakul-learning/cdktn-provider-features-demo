// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eks_identity_provider_config
...
export class EksIdentityProviderConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksIdentityProviderConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eks_identity_provider_config#import import section} in the documentation of this resource for the id to use
