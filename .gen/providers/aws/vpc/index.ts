// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc
...
export class Vpc extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/vpc aws_vpc} Resource
  *
  * @param scope The scope in which to define this construct
