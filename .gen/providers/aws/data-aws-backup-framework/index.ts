// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/backup_framework
...
export class DataAwsBackupFrameworkControlInputParameterOutputReference extends cdktn.ComplexObject {
...
export class DataAwsBackupFrameworkControlInputParameterList extends cdktn.ComplexList {
...
export class DataAwsBackupFrameworkControlScopeOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsBackupFrameworkControlScopeList extends cdktn.ComplexList {
...
export class DataAwsBackupFrameworkControlOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _inputParameter = new DataAwsBackupFrameworkControlInputParameterList(this, "input_parameter", false);
...
export class DataAwsBackupFrameworkControlList extends cdktn.ComplexList {
...
export class DataAwsBackupFramework extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBackupFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/backup_framework#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/backup_framework aws_backup_framework} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _control = new DataAwsBackupFrameworkControlList(this, "control", false);
  public get control() {
