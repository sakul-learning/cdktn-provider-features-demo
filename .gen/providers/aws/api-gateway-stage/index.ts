// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/api_gateway_stage
...
export class ApiGatewayStage extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayStage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/api_gateway_stage#import import section} in the documentation of this resource for the id to use
