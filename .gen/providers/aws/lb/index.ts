// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lb
...
export interface LbConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly healthCheckLogs?: LbHealthCheckLogs;
  /**
  * ipam_pools block
  *
  ...
  */
  readonly subnetMapping?: LbSubnetMapping[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
...
export class LbAccessLogsOutputReference extends cdktn.ComplexObject {
...
export class LbConnectionLogsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface LbHealthCheckLogs {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lb#bucket Lb#bucket}
  */
  readonly bucket: string;
...
export function lbHealthCheckLogsToTerraform(struct?: LbHealthCheckLogsOutputReference | LbHealthCheckLogs): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function lbHealthCheckLogsToHclTerraform(struct?: LbHealthCheckLogsOutputReference | LbHealthCheckLogs): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class LbHealthCheckLogsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): LbHealthCheckLogs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._bucket !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: LbHealthCheckLogs | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._bucket = undefined;
      this._enabled = undefined;
...
export class LbIpamPoolsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class LbMinimumLoadBalancerCapacityOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function lbSubnetMappingToTerraform(struct?: LbSubnetMapping | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function lbSubnetMappingToHclTerraform(struct?: LbSubnetMapping | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class LbSubnetMappingOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): LbSubnetMapping | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: LbSubnetMapping | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class LbSubnetMappingList extends cdktn.ComplexList {
  public internalValue? : LbSubnetMapping[] | cdktn.IResolvable
...
export class Lb extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Lb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _healthCheckLogs = new LbHealthCheckLogsOutputReference(this, "health_check_logs");
  public get healthCheckLogs() {
    return this._healthCheckLogs;
  }
  public putHealthCheckLogs(value: LbHealthCheckLogs) {
  ...
  public putSubnetMapping(value: LbSubnetMapping[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      health_check_logs: lbHealthCheckLogsToTerraform(this._healthCheckLogs.internalValue),
      ...
      subnet_mapping: cdktn.listMapper(lbSubnetMappingToTerraform, true)(this._subnetMapping.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      health_check_logs: {
        value: lbHealthCheckLogsToHclTerraform(this._healthCheckLogs.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "LbHealthCheckLogsList",
      },
      ipam_pools: {
      ...
      subnet_mapping: {
        value: cdktn.listMapperHcl(lbSubnetMappingToHclTerraform, true)(this._subnetMapping.internalValue),
        isBlock: true,
        type: "set",
