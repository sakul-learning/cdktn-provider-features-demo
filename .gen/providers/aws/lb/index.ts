// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/lb
...
export class Lb extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Lb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/lb#import import section} in the documentation of this resource for the id to use
