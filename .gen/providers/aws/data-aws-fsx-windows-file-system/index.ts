// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/fsx_windows_file_system
...
export class DataAwsFsxWindowsFileSystemAuditLogConfigurationOutputReference extends cdktn.ComplexObject {
...
export class DataAwsFsxWindowsFileSystemAuditLogConfigurationList extends cdktn.ComplexList {
...
export function dataAwsFsxWindowsFileSystemDiskIopsConfigurationToHclTerraform(struct?: DataAwsFsxWindowsFileSystemDiskIopsConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsFsxWindowsFileSystemDiskIopsConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsFsxWindowsFileSystemDiskIopsConfigurationList extends cdktn.ComplexList {
...
export class DataAwsFsxWindowsFileSystem extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsFsxWindowsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/fsx_windows_file_system#import import section} in the documentation of this resource for the id to use
