// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/evidently_project
...
export class EvidentlyProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EvidentlyProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/evidently_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/evidently_project aws_evidently_project} Resource
  *
  * @param scope The scope in which to define this construct
