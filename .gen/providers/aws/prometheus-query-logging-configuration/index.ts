// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/prometheus_query_logging_configuration
...
export class PrometheusQueryLoggingConfiguration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusQueryLoggingConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/prometheus_query_logging_configuration#import import section} in the documentation of this resource for the id to use
