// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eks_capability
...
export class EksCapability extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksCapability that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eks_capability#import import section} in the documentation of this resource for the id to use
