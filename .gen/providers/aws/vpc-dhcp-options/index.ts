// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/vpc_dhcp_options
...
export class VpcDhcpOptions extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcDhcpOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/vpc_dhcp_options#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/vpc_dhcp_options aws_vpc_dhcp_options} Resource
  *
  * @param scope The scope in which to define this construct
