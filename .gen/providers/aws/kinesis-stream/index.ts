// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/kinesis_stream
...
export class KinesisStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/kinesis_stream#import import section} in the documentation of this resource for the id to use
