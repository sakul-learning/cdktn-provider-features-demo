// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/iam_group
...
export class DataAwsIamGroupUsersOutputReference extends cdktn.ComplexObject {
...
export class DataAwsIamGroupUsersList extends cdktn.ComplexList {
...
export class DataAwsIamGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/iam_group#import import section} in the documentation of this resource for the id to use
