// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lambda_function_recursion_config
...
export class LambdaFunctionRecursionConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaFunctionRecursionConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lambda_function_recursion_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lambda_function_recursion_config aws_lambda_function_recursion_config} Resource
  *
  * @param scope The scope in which to define this construct
