// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ram_resource_share
...
export class DataAwsRamResourceShare extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRamResourceShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ram_resource_share#import import section} in the documentation of this resource for the id to use
