// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/chimesdkvoice_global_settings
...
export class ChimesdkvoiceGlobalSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimesdkvoiceGlobalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/chimesdkvoice_global_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/chimesdkvoice_global_settings aws_chimesdkvoice_global_settings} Resource
  *
  * @param scope The scope in which to define this construct
