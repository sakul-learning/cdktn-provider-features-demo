// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/lambda_function_url
...
export class DataAwsLambdaFunctionUrlCorsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsLambdaFunctionUrlCorsList extends cdktn.ComplexList {
...
export class DataAwsLambdaFunctionUrl extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLambdaFunctionUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/lambda_function_url#import import section} in the documentation of this resource for the id to use
