// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ec2_client_vpn_endpoint
...
export interface DataAwsEc2ClientVpnEndpointConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly filter?: DataAwsEc2ClientVpnEndpointFilter[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
...
export class DataAwsEc2ClientVpnEndpointAuthenticationOptionsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsEc2ClientVpnEndpointAuthenticationOptionsList extends cdktn.ComplexList {
...
export class DataAwsEc2ClientVpnEndpointClientConnectOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEc2ClientVpnEndpointClientConnectOptionsList extends cdktn.ComplexList {
...
export class DataAwsEc2ClientVpnEndpointClientLoginBannerOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEc2ClientVpnEndpointClientLoginBannerOptionsList extends cdktn.ComplexList {
...
export class DataAwsEc2ClientVpnEndpointClientRouteEnforcementOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEc2ClientVpnEndpointClientRouteEnforcementOptionsList extends cdktn.ComplexList {
...
export class DataAwsEc2ClientVpnEndpointConnectionLogOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEc2ClientVpnEndpointConnectionLogOptionsList extends cdktn.ComplexList {
...
export interface DataAwsEc2ClientVpnEndpointTransitGatewayConfiguration {
}

export function dataAwsEc2ClientVpnEndpointTransitGatewayConfigurationToTerraform(struct?: DataAwsEc2ClientVpnEndpointTransitGatewayConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEc2ClientVpnEndpointTransitGatewayConfigurationToHclTerraform(struct?: DataAwsEc2ClientVpnEndpointTransitGatewayConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsEc2ClientVpnEndpointTransitGatewayConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsEc2ClientVpnEndpointTransitGatewayConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationOutputReference {
    return new DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataAwsEc2ClientVpnEndpointFilterToTerraform(struct?: DataAwsEc2ClientVpnEndpointFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEc2ClientVpnEndpointFilterToHclTerraform(struct?: DataAwsEc2ClientVpnEndpointFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsEc2ClientVpnEndpointFilterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsEc2ClientVpnEndpointFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAwsEc2ClientVpnEndpointFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsEc2ClientVpnEndpointFilterList extends cdktn.ComplexList {
  public internalValue? : DataAwsEc2ClientVpnEndpointFilter[] | cdktn.IResolvable
...
export function dataAwsEc2ClientVpnEndpointTimeoutsToTerraform(struct?: DataAwsEc2ClientVpnEndpointTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEc2ClientVpnEndpointTimeoutsToHclTerraform(struct?: DataAwsEc2ClientVpnEndpointTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsEc2ClientVpnEndpointTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): DataAwsEc2ClientVpnEndpointTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DataAwsEc2ClientVpnEndpointTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2ClientVpnEndpoint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2ClientVpnEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ec2_client_vpn_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/ec2_client_vpn_endpoint aws_ec2_client_vpn_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _transitGatewayConfiguration = new DataAwsEc2ClientVpnEndpointTransitGatewayConfigurationList(this, "transit_gateway_configuration", false);
  ...
  public putFilter(value: DataAwsEc2ClientVpnEndpointFilter[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktn.listMapper(dataAwsEc2ClientVpnEndpointFilterToTerraform, true)(this._filter.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktn.listMapperHcl(dataAwsEc2ClientVpnEndpointFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
