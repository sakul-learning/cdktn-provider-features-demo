// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/storagegateway_cache
...
export class StoragegatewayCache extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewayCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/storagegateway_cache#import import section} in the documentation of this resource for the id to use
