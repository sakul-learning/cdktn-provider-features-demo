// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/glue_registry
...
export class GlueRegistry extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/glue_registry#import import section} in the documentation of this resource for the id to use
