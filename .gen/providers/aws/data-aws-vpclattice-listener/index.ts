// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/vpclattice_listener
...
export class DataAwsVpclatticeListenerDefaultActionFixedResponseOutputReference extends cdktn.ComplexObject {
...
export class DataAwsVpclatticeListenerDefaultActionFixedResponseList extends cdktn.ComplexList {
...
export class DataAwsVpclatticeListenerDefaultActionForwardTargetGroupsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsVpclatticeListenerDefaultActionForwardTargetGroupsList extends cdktn.ComplexList {
...
export class DataAwsVpclatticeListenerDefaultActionForwardOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsVpclatticeListenerDefaultActionForwardList extends cdktn.ComplexList {
...
export class DataAwsVpclatticeListenerDefaultActionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsVpclatticeListenerDefaultActionList extends cdktn.ComplexList {
...
export class DataAwsVpclatticeListener extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpclatticeListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
