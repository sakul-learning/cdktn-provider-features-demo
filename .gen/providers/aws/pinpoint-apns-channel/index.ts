// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/pinpoint_apns_channel
...
export class PinpointApnsChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointApnsChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/pinpoint_apns_channel#import import section} in the documentation of this resource for the id to use
