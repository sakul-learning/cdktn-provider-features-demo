// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_image_block_public_access
...
export class Ec2ImageBlockPublicAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ImageBlockPublicAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_image_block_public_access#import import section} in the documentation of this resource for the id to use
