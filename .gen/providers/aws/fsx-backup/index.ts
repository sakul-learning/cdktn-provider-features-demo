// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/fsx_backup
...
export class FsxBackup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/fsx_backup#import import section} in the documentation of this resource for the id to use
