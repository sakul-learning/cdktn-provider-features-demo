// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/vpc_security_group_rules_exclusive
...
export class VpcSecurityGroupRulesExclusive extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcSecurityGroupRulesExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/vpc_security_group_rules_exclusive#import import section} in the documentation of this resource for the id to use
