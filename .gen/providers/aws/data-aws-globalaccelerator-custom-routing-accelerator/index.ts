// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/globalaccelerator_custom_routing_accelerator
...
export class DataAwsGlobalacceleratorCustomRoutingAccelerator extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlobalacceleratorCustomRoutingAccelerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/globalaccelerator_custom_routing_accelerator#import import section} in the documentation of this resource for the id to use
