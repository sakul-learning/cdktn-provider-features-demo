// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/quicksight_vpc_connection
...
export class QuicksightVpcConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/quicksight_vpc_connection#import import section} in the documentation of this resource for the id to use
