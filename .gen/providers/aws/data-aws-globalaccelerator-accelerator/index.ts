// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/globalaccelerator_accelerator
...
export class DataAwsGlobalacceleratorAcceleratorAttributesOutputReference extends cdktn.ComplexObject {
...
export class DataAwsGlobalacceleratorAcceleratorAttributesList extends cdktn.ComplexList {
...
export class DataAwsGlobalacceleratorAcceleratorIpSetsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsGlobalacceleratorAcceleratorIpSetsList extends cdktn.ComplexList {
...
export class DataAwsGlobalacceleratorAccelerator extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlobalacceleratorAccelerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/globalaccelerator_accelerator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/globalaccelerator_accelerator aws_globalaccelerator_accelerator} Data Source
  *
  * @param scope The scope in which to define this construct
