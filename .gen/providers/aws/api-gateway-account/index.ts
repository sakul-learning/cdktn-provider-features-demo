// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/api_gateway_account
...
export class ApiGatewayAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/api_gateway_account#import import section} in the documentation of this resource for the id to use
