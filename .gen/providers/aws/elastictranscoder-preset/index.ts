// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/elastictranscoder_preset
...
export class ElastictranscoderPreset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElastictranscoderPreset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/elastictranscoder_preset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/elastictranscoder_preset aws_elastictranscoder_preset} Resource
  *
  * @param scope The scope in which to define this construct
