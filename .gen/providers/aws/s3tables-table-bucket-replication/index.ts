// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/s3tables_table_bucket_replication
...
export class S3TablesTableBucketReplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3TablesTableBucketReplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/s3tables_table_bucket_replication#import import section} in the documentation of this resource for the id to use
