// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/wafregional_size_constraint_set
...
export class WafregionalSizeConstraintSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalSizeConstraintSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/wafregional_size_constraint_set#import import section} in the documentation of this resource for the id to use
