// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dms_replication_config
...
export class DmsReplicationConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsReplicationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dms_replication_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/dms_replication_config aws_dms_replication_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      compute_config: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "DmsReplicationConfigComputeConfigList",
      },
      timeouts: {
        value: dmsReplicationConfigTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DmsReplicationConfigTimeouts",
      },
    };
