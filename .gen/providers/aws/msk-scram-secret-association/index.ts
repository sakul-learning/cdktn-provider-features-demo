// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/msk_scram_secret_association
...
export class MskScramSecretAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskScramSecretAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/msk_scram_secret_association#import import section} in the documentation of this resource for the id to use
