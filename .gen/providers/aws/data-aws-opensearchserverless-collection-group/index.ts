// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/opensearchserverless_collection_group
...
export interface DataAwsOpensearchserverlessCollectionGroupCapacityLimits {
}

export function dataAwsOpensearchserverlessCollectionGroupCapacityLimitsToTerraform(struct?: DataAwsOpensearchserverlessCollectionGroupCapacityLimits): any {
...
export function dataAwsOpensearchserverlessCollectionGroupCapacityLimitsToHclTerraform(struct?: DataAwsOpensearchserverlessCollectionGroupCapacityLimits): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsOpensearchserverlessCollectionGroupCapacityLimitsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsOpensearchserverlessCollectionGroupCapacityLimits | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsOpensearchserverlessCollectionGroupCapacityLimits | undefined) {
    if (value === undefined) {
...
export class DataAwsOpensearchserverlessCollectionGroupCapacityLimitsList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsOpensearchserverlessCollectionGroupCapacityLimitsOutputReference {
    return new DataAwsOpensearchserverlessCollectionGroupCapacityLimitsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsOpensearchserverlessCollectionGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOpensearchserverlessCollectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/opensearchserverless_collection_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/opensearchserverless_collection_group aws_opensearchserverless_collection_group} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _capacityLimits = new DataAwsOpensearchserverlessCollectionGroupCapacityLimitsList(this, "capacity_limits", false);
