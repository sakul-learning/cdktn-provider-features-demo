// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/odb_cloud_exadata_infrastructure
...
export class OdbCloudExadataInfrastructure extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudExadataInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/odb_cloud_exadata_infrastructure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/odb_cloud_exadata_infrastructure aws_odb_cloud_exadata_infrastructure} Resource
  *
  * @param scope The scope in which to define this construct
