// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/emr_instance_group
...
export class EmrInstanceGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrInstanceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/emr_instance_group#import import section} in the documentation of this resource for the id to use
