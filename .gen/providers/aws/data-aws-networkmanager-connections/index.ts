// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/networkmanager_connections
...
export class DataAwsNetworkmanagerConnections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/networkmanager_connections#import import section} in the documentation of this resource for the id to use
