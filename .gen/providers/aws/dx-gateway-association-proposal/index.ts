// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/dx_gateway_association_proposal
...
export class DxGatewayAssociationProposal extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DxGatewayAssociationProposal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/dx_gateway_association_proposal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/dx_gateway_association_proposal aws_dx_gateway_association_proposal} Resource
  *
  * @param scope The scope in which to define this construct
