// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/fsx_file_cache
...
export class FsxFileCache extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxFileCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/fsx_file_cache#import import section} in the documentation of this resource for the id to use
