// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/db_proxy_default_target_group
...
export class DbProxyDefaultTargetGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbProxyDefaultTargetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/db_proxy_default_target_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/db_proxy_default_target_group aws_db_proxy_default_target_group} Resource
  *
  * @param scope The scope in which to define this construct
