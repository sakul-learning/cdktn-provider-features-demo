// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/storagegateway_gateway
...
export class StoragegatewayGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewayGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/storagegateway_gateway#import import section} in the documentation of this resource for the id to use
