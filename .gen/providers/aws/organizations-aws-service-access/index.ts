// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/organizations_aws_service_access
...
export class OrganizationsAwsServiceAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationsAwsServiceAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/organizations_aws_service_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/organizations_aws_service_access aws_organizations_aws_service_access} Resource
  *
  * @param scope The scope in which to define this construct
