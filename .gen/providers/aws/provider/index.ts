// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs
...
export class AwsProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AwsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs#import import section} in the documentation of this resource for the id to use
