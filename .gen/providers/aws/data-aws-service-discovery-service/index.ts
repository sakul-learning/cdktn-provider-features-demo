// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/service_discovery_service
...
export class DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList extends cdktn.ComplexList {
...
export class DataAwsServiceDiscoveryServiceDnsConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsServiceDiscoveryServiceDnsConfigList extends cdktn.ComplexList {
...
export class DataAwsServiceDiscoveryServiceHealthCheckConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsServiceDiscoveryServiceHealthCheckConfigList extends cdktn.ComplexList {
...
export class DataAwsServiceDiscoveryServiceHealthCheckCustomConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList extends cdktn.ComplexList {
...
export class DataAwsServiceDiscoveryService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsServiceDiscoveryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/service_discovery_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/service_discovery_service aws_service_discovery_service} Data Source
  *
  * @param scope The scope in which to define this construct
