...
MedialiveChannelVpcOutputReference} from './index-structs/index.ts';
...
export class MedialiveChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/medialive_channel#import import section} in the documentation of this resource for the id to use
