// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/workspaces_bundle
...
export class DataAwsWorkspacesBundle extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWorkspacesBundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/workspaces_bundle#import import section} in the documentation of this resource for the id to use
