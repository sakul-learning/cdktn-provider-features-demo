// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpc_ipam_pools
...
export interface DataAwsVpcIpamPoolsConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly filter?: DataAwsVpcIpamPoolsFilter[] | cdktn.IResolvable;
}
...
export class DataAwsVpcIpamPoolsIpamPoolsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsVpcIpamPoolsIpamPoolsList extends cdktn.ComplexList {
...
export function dataAwsVpcIpamPoolsFilterToTerraform(struct?: DataAwsVpcIpamPoolsFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsVpcIpamPoolsFilterToHclTerraform(struct?: DataAwsVpcIpamPoolsFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsVpcIpamPoolsFilterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsVpcIpamPoolsFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAwsVpcIpamPoolsFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsVpcIpamPoolsFilterList extends cdktn.ComplexList {
  public internalValue? : DataAwsVpcIpamPoolsFilter[] | cdktn.IResolvable
...
export class DataAwsVpcIpamPools extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpamPools that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpc_ipam_pools#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpc_ipam_pools aws_vpc_ipam_pools} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putFilter(value: DataAwsVpcIpamPoolsFilter[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktn.listMapper(dataAwsVpcIpamPoolsFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktn.listMapperHcl(dataAwsVpcIpamPoolsFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
