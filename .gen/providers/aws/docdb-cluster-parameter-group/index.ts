// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/docdb_cluster_parameter_group
...
export class DocdbClusterParameterGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbClusterParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/docdb_cluster_parameter_group#import import section} in the documentation of this resource for the id to use
