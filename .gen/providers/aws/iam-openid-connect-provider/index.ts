// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_openid_connect_provider
...
export class IamOpenidConnectProvider extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamOpenidConnectProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_openid_connect_provider#import import section} in the documentation of this resource for the id to use
