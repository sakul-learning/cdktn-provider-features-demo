// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ebs_volume_copy
...
export class EbsVolumeCopy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsVolumeCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ebs_volume_copy#import import section} in the documentation of this resource for the id to use
