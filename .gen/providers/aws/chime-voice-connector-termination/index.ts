// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/chime_voice_connector_termination
...
export class ChimeVoiceConnectorTermination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimeVoiceConnectorTermination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/chime_voice_connector_termination#import import section} in the documentation of this resource for the id to use
