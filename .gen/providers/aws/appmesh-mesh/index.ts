// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/appmesh_mesh
...
export class AppmeshMeshSpecEgressFilterOutputReference extends cdktn.ComplexObject {
...
export class AppmeshMeshSpecServiceDiscoveryOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class AppmeshMeshSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class AppmeshMesh extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppmeshMesh that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/appmesh_mesh#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/appmesh_mesh aws_appmesh_mesh} Resource
  *
  * @param scope The scope in which to define this construct
