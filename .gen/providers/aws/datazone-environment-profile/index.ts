// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datazone_environment_profile
...
export class DatazoneEnvironmentProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneEnvironmentProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/datazone_environment_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      user_parameters: cdktn.listMapper(datazoneEnvironmentProfileUserParametersToTerraform, true)(this._userParameters.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      user_parameters: {
        value: cdktn.listMapperHcl(datazoneEnvironmentProfileUserParametersToHclTerraform, true)(this._userParameters.internalValue),
        isBlock: true,
        type: "list",
