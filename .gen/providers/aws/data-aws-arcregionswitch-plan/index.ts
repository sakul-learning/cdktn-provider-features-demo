// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/arcregionswitch_plan
...
export class DataAwsArcregionswitchPlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsArcregionswitchPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/arcregionswitch_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/arcregionswitch_plan aws_arcregionswitch_plan} Data Source
  *
  * @param scope The scope in which to define this construct
