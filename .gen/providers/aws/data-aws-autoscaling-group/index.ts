// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/autoscaling_group
...
export class DataAwsAutoscalingGroupInstanceMaintenancePolicyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsAutoscalingGroupInstanceMaintenancePolicy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsAutoscalingGroupInstanceMaintenancePolicy | undefined) {
    if (value === undefined) {
...
export class DataAwsAutoscalingGroupInstanceMaintenancePolicyList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsAutoscalingGroupInstanceMaintenancePolicyOutputReference {
    return new DataAwsAutoscalingGroupInstanceMaintenancePolicyOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsAutoscalingGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAutoscalingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/autoscaling_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/autoscaling_group aws_autoscaling_group} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _instanceMaintenancePolicy = new DataAwsAutoscalingGroupInstanceMaintenancePolicyList(this, "instance_maintenance_policy", false);
