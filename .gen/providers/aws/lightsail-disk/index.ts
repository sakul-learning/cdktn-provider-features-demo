// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lightsail_disk
...
export class LightsailDisk extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lightsail_disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lightsail_disk aws_lightsail_disk} Resource
  *
  * @param scope The scope in which to define this construct
