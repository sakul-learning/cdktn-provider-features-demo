// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/fsx_openzfs_snapshot
...
export class DataAwsFsxOpenzfsSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsFsxOpenzfsSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/fsx_openzfs_snapshot#import import section} in the documentation of this resource for the id to use
