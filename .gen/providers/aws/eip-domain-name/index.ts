// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eip_domain_name
...
export interface EipDomainNameConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function eipDomainNameTimeoutsToTerraform(struct?: EipDomainNameTimeouts | cdktn.IResolvable): any {
...
export function eipDomainNameTimeoutsToHclTerraform(struct?: EipDomainNameTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class EipDomainNameTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EipDomainNameTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: EipDomainNameTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class EipDomainName extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EipDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eip_domain_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/eip_domain_name aws_eip_domain_name} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EipDomainNameConfig
  */
  public constructor(scope: Construct, id: string, config: EipDomainNameConfig) {
    super(scope, id, {
  ...
  public putTimeouts(value: EipDomainNameTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: eipDomainNameTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EipDomainNameTimeouts",
      },
    };
