// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lightsail_lb_stickiness_policy
...
export class LightsailLbStickinessPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailLbStickinessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lightsail_lb_stickiness_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/lightsail_lb_stickiness_policy aws_lightsail_lb_stickiness_policy} Resource
  *
  * @param scope The scope in which to define this construct
