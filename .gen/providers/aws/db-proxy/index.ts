// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/db_proxy
...
export class DbProxy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/db_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/db_proxy aws_db_proxy} Resource
  *
  * @param scope The scope in which to define this construct
