// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/controltower_baseline
...
export class ControltowerBaselineParametersList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): ControltowerBaselineParametersOutputReference {
    return new ControltowerBaselineParametersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ControltowerBaselineTimeouts {
  /**
...
export class ControltowerBaseline extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ControltowerBaseline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/controltower_baseline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/controltower_baseline aws_controltower_baseline} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ControltowerBaselineConfig
  */
  public constructor(scope: Construct, id: string, config: ControltowerBaselineConfig) {
    super(scope, id, {
  ...
  private _parameters = new ControltowerBaselineParametersList(this, "parameters", false);
  ...
  private _timeouts = new ControltowerBaselineTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ControltowerBaselineTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: controltowerBaselineTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ControltowerBaselineTimeouts",
      },
    };
