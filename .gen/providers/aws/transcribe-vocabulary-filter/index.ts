// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/transcribe_vocabulary_filter
...
export class TranscribeVocabularyFilter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TranscribeVocabularyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/transcribe_vocabulary_filter#import import section} in the documentation of this resource for the id to use
