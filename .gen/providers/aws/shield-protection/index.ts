// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/shield_protection
...
export class ShieldProtection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/shield_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/shield_protection aws_shield_protection} Resource
  *
  * @param scope The scope in which to define this construct
