// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lightsail_instance
...
export class LightsailInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/lightsail_instance#import import section} in the documentation of this resource for the id to use
