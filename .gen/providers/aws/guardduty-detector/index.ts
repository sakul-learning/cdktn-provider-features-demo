// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/guardduty_detector
...
export class GuarddutyDetector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/guardduty_detector#import import section} in the documentation of this resource for the id to use
