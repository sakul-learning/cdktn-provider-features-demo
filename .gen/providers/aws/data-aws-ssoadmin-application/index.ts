// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/ssoadmin_application
...
export class DataAwsSsoadminApplicationPortalOptionsSignInOptionsOutputReference extends cdktn.ComplexObject {
...
export class DataAwsSsoadminApplicationPortalOptionsSignInOptionsList extends cdktn.ComplexList {
...
export class DataAwsSsoadminApplicationPortalOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsSsoadminApplicationPortalOptionsList extends cdktn.ComplexList {
...
export class DataAwsSsoadminApplication extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsoadminApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/ssoadmin_application#import import section} in the documentation of this resource for the id to use
