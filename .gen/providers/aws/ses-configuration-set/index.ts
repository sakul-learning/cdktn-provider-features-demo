// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ses_configuration_set
...
export class SesConfigurationSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesConfigurationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ses_configuration_set#import import section} in the documentation of this resource for the id to use
