// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/redshift_endpoint_access
...
export class RedshiftEndpointAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftEndpointAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/redshift_endpoint_access#import import section} in the documentation of this resource for the id to use
