// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/oam_sink
...
export function oamSinkTimeoutsToTerraform(struct?: OamSinkTimeouts | cdktn.IResolvable): any {
...
export function oamSinkTimeoutsToHclTerraform(struct?: OamSinkTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class OamSinkTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OamSinkTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: OamSinkTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class OamSink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OamSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/oam_sink#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/oam_sink aws_oam_sink} Resource
  *
  * @param scope The scope in which to define this construct
