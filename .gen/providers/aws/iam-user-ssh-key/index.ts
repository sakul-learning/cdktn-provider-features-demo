// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iam_user_ssh_key
...
export class IamUserSshKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamUserSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iam_user_ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iam_user_ssh_key aws_iam_user_ssh_key} Resource
  *
  * @param scope The scope in which to define this construct
