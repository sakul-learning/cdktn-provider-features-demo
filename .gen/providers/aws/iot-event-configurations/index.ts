// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/iot_event_configurations
...
export class IotEventConfigurations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotEventConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/iot_event_configurations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/iot_event_configurations aws_iot_event_configurations} Resource
  *
  * @param scope The scope in which to define this construct
