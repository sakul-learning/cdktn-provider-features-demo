// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/organizations_organization
...
export class OrganizationsOrganization extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationsOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/organizations_organization#import import section} in the documentation of this resource for the id to use
