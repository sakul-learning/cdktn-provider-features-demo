// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/waf_ipset
...
export class WafIpset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafIpset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/waf_ipset#import import section} in the documentation of this resource for the id to use
