// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/bedrock_provisioned_model_throughput
...
export class BedrockProvisionedModelThroughput extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockProvisionedModelThroughput that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/bedrock_provisioned_model_throughput#import import section} in the documentation of this resource for the id to use
