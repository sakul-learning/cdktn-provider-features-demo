// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/transcribe_vocabulary
...
export class TranscribeVocabulary extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TranscribeVocabulary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/transcribe_vocabulary#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/transcribe_vocabulary aws_transcribe_vocabulary} Resource
  *
  * @param scope The scope in which to define this construct
