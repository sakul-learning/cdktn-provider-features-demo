// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/fsx_openzfs_snapshot
...
export class FsxOpenzfsSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxOpenzfsSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/fsx_openzfs_snapshot#import import section} in the documentation of this resource for the id to use
