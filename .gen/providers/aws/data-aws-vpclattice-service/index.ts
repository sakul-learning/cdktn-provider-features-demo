// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpclattice_service
...
export class DataAwsVpclatticeServiceDnsEntryOutputReference extends cdktn.ComplexObject {
...
export class DataAwsVpclatticeServiceDnsEntryList extends cdktn.ComplexList {
...
export class DataAwsVpclatticeService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpclatticeService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/vpclattice_service#import import section} in the documentation of this resource for the id to use
