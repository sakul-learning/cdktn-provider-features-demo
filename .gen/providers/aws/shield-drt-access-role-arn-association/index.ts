// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/shield_drt_access_role_arn_association
...
export class ShieldDrtAccessRoleArnAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldDrtAccessRoleArnAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/shield_drt_access_role_arn_association#import import section} in the documentation of this resource for the id to use
