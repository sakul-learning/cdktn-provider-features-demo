// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/connect_hours_of_operation
...
export class ConnectHoursOfOperation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectHoursOfOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/connect_hours_of_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/connect_hours_of_operation aws_connect_hours_of_operation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      config: cdktn.listMapper(connectHoursOfOperationConfigAToTerraform, true)(this._config.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      config: {
        value: cdktn.listMapperHcl(connectHoursOfOperationConfigAToHclTerraform, true)(this._config.internalValue),
        isBlock: true,
        type: "set",
