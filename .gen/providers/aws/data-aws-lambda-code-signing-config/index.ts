// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/lambda_code_signing_config
...
export class DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference extends cdktn.ComplexObject {
...
export class DataAwsLambdaCodeSigningConfigAllowedPublishersList extends cdktn.ComplexList {
...
export class DataAwsLambdaCodeSigningConfigPoliciesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsLambdaCodeSigningConfigPoliciesList extends cdktn.ComplexList {
...
export class DataAwsLambdaCodeSigningConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLambdaCodeSigningConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/lambda_code_signing_config#import import section} in the documentation of this resource for the id to use
