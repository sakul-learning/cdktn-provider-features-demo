// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/cloudfront_trust_store
...
export class CloudfrontTrustStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontTrustStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/cloudfront_trust_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/cloudfront_trust_store aws_cloudfront_trust_store} Resource
  *
  * @param scope The scope in which to define this construct
