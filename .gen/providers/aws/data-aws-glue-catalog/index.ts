// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/glue_catalog
...
export class DataAwsGlueCatalog extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlueCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/glue_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/glue_catalog aws_glue_catalog} Data Source
  *
  * @param scope The scope in which to define this construct
