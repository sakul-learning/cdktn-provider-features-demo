// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index
...
export interface DataAwsLocationPlaceIndexConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index#id DataAwsLocationPlaceIndex#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index#index_name DataAwsLocationPlaceIndex#index_name}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index#tags DataAwsLocationPlaceIndex#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index aws_location_place_index}
*/
export class DataAwsLocationPlaceIndex extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationPlaceIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/location_place_index aws_location_place_index} Data Source
  *
  * @param scope The scope in which to define this construct
