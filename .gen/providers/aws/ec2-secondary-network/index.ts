// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_secondary_network
...
export interface Ec2SecondaryNetworkTimeouts {
  /**
...
export class Ec2SecondaryNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SecondaryNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_secondary_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ec2_secondary_network aws_ec2_secondary_network} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _ipv4CidrBlockAssociations = new Ec2SecondaryNetworkIpv4CidrBlockAssociationsList(this, "ipv4_cidr_block_associations", false);
  ...
  private _timeouts = new Ec2SecondaryNetworkTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: Ec2SecondaryNetworkTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: ec2SecondaryNetworkTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "Ec2SecondaryNetworkTimeouts",
      },
    };
