// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ssoadmin_permission_set_inline_policy
...
export class SsoadminPermissionSetInlinePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoadminPermissionSetInlinePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/ssoadmin_permission_set_inline_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: ssoadminPermissionSetInlinePolicyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "SsoadminPermissionSetInlinePolicyTimeouts",
      },
    };
