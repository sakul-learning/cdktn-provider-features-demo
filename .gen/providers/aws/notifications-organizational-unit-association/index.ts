// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/notifications_organizational_unit_association
...
export class NotificationsOrganizationalUnitAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationsOrganizationalUnitAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/notifications_organizational_unit_association#import import section} in the documentation of this resource for the id to use
