// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/medialive_input
...
export class MedialiveInput extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveInput that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/medialive_input#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/medialive_input aws_medialive_input} Resource
  *
  * @param scope The scope in which to define this construct
