// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/acm_certificate_validation
...
export function acmCertificateValidationTimeoutsToTerraform(struct?: AcmCertificateValidationTimeouts | cdktn.IResolvable): any {
...
export function acmCertificateValidationTimeoutsToHclTerraform(struct?: AcmCertificateValidationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class AcmCertificateValidationTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AcmCertificateValidationTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: AcmCertificateValidationTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class AcmCertificateValidation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmCertificateValidation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/acm_certificate_validation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/acm_certificate_validation aws_acm_certificate_validation} Resource
  *
  * @param scope The scope in which to define this construct
