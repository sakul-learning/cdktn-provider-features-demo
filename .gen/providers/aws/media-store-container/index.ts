// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/media_store_container
...
export class MediaStoreContainer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaStoreContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/media_store_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/media_store_container aws_media_store_container} Resource
  *
  * @param scope The scope in which to define this construct
