// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/uxc_services
...
export class DataAwsUxcServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsUxcServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/uxc_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/uxc_services aws_uxc_services} Data Source
  *
  * @param scope The scope in which to define this construct
