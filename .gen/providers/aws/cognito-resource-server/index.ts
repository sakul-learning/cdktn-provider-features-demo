// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/cognito_resource_server
...
export class CognitoResourceServer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoResourceServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/cognito_resource_server#import import section} in the documentation of this resource for the id to use
