// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/appintegrations_data_integration
...
export class AppintegrationsDataIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppintegrationsDataIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/appintegrations_data_integration#import import section} in the documentation of this resource for the id to use
