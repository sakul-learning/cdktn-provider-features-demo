// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/elasticache_replication_group
...
export class DataAwsElasticacheReplicationGroupLogDeliveryConfigurationOutputReference extends cdktn.ComplexObject {
...
export class DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList extends cdktn.ComplexList {
...
export interface DataAwsElasticacheReplicationGroupNodeGroupConfiguration {
}

export function dataAwsElasticacheReplicationGroupNodeGroupConfigurationToTerraform(struct?: DataAwsElasticacheReplicationGroupNodeGroupConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsElasticacheReplicationGroupNodeGroupConfigurationToHclTerraform(struct?: DataAwsElasticacheReplicationGroupNodeGroupConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsElasticacheReplicationGroupNodeGroupConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsElasticacheReplicationGroupNodeGroupConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsElasticacheReplicationGroupNodeGroupConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsElasticacheReplicationGroupNodeGroupConfigurationList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsElasticacheReplicationGroupNodeGroupConfigurationOutputReference {
    return new DataAwsElasticacheReplicationGroupNodeGroupConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsElasticacheReplicationGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticacheReplicationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/elasticache_replication_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/elasticache_replication_group aws_elasticache_replication_group} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _nodeGroupConfiguration = new DataAwsElasticacheReplicationGroupNodeGroupConfigurationList(this, "node_group_configuration", true);
