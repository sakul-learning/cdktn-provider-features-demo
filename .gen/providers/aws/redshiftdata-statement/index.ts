// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/redshiftdata_statement
...
export class RedshiftdataStatement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftdataStatement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/redshiftdata_statement#import import section} in the documentation of this resource for the id to use
