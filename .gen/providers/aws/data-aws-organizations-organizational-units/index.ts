// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/organizations_organizational_units
...
export class DataAwsOrganizationsOrganizationalUnitsChildrenOutputReference extends cdktn.ComplexObject {
...
export class DataAwsOrganizationsOrganizationalUnitsChildrenList extends cdktn.ComplexList {
...
export class DataAwsOrganizationsOrganizationalUnits extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsOrganizationalUnits that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/organizations_organizational_units#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/organizations_organizational_units aws_organizations_organizational_units} Data Source
  *
  * @param scope The scope in which to define this construct
