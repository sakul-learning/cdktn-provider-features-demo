// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/route53_delegation_set
...
export class Route53DelegationSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53DelegationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/route53_delegation_set#import import section} in the documentation of this resource for the id to use
