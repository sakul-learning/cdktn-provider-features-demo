// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_role
...
export interface IamRoleConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly inlinePolicy?: IamRoleInlinePolicy[] | cdktn.IResolvable;
}
...
export function iamRoleInlinePolicyToTerraform(struct?: IamRoleInlinePolicy | cdktn.IResolvable): any {
...
export function iamRoleInlinePolicyToHclTerraform(struct?: IamRoleInlinePolicy | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class IamRoleInlinePolicyOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IamRoleInlinePolicy | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: IamRoleInlinePolicy | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class IamRoleInlinePolicyList extends cdktn.ComplexList {
  public internalValue? : IamRoleInlinePolicy[] | cdktn.IResolvable
...
export class IamRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  public putInlinePolicy(value: IamRoleInlinePolicy[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      inline_policy: cdktn.listMapper(iamRoleInlinePolicyToTerraform, true)(this._inlinePolicy.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      inline_policy: {
        value: cdktn.listMapperHcl(iamRoleInlinePolicyToHclTerraform, true)(this._inlinePolicy.internalValue),
        isBlock: true,
        type: "set",
