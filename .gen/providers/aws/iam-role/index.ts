// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iam_role
...
export class IamRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/iam_role#import import section} in the documentation of this resource for the id to use
