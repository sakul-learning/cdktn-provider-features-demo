// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/odb_db_node
...
export class DataAwsOdbDbNode extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbDbNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/odb_db_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/odb_db_node aws_odb_db_node} Data Source
  *
  * @param scope The scope in which to define this construct
