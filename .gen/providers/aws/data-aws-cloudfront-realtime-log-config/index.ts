// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/cloudfront_realtime_log_config
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference extends cdktn.ComplexObject {
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList extends cdktn.ComplexList {
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointList extends cdktn.ComplexList {
...
export class DataAwsCloudfrontRealtimeLogConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudfrontRealtimeLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/cloudfront_realtime_log_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/data-sources/cloudfront_realtime_log_config aws_cloudfront_realtime_log_config} Data Source
  *
  * @param scope The scope in which to define this construct
