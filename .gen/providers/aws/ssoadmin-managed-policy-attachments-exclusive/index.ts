// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ssoadmin_managed_policy_attachments_exclusive
...
export class SsoadminManagedPolicyAttachmentsExclusive extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoadminManagedPolicyAttachmentsExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/ssoadmin_managed_policy_attachments_exclusive#import import section} in the documentation of this resource for the id to use
