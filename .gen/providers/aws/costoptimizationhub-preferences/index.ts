// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/costoptimizationhub_preferences
...
export class CostoptimizationhubPreferences extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CostoptimizationhubPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/costoptimizationhub_preferences#import import section} in the documentation of this resource for the id to use
