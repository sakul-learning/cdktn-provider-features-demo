// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/shield_subscription
...
export class ShieldSubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/shield_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/shield_subscription aws_shield_subscription} Resource
  *
  * @param scope The scope in which to define this construct
