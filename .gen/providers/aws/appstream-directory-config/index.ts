// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/appstream_directory_config
...
export class AppstreamDirectoryConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppstreamDirectoryConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/appstream_directory_config#import import section} in the documentation of this resource for the id to use
