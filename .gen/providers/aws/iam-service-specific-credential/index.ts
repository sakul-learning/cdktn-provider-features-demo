// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_service_specific_credential
...
export class IamServiceSpecificCredential extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceSpecificCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_service_specific_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/iam_service_specific_credential aws_iam_service_specific_credential} Resource
  *
  * @param scope The scope in which to define this construct
