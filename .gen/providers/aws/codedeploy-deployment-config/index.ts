// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/codedeploy_deployment_config
...
export class CodedeployDeploymentConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodedeployDeploymentConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/codedeploy_deployment_config#import import section} in the documentation of this resource for the id to use
